...
<?php $component = $__env->getContainer()->make(App\View\Components\AppLayout::class, ['activemenu' => 'portal-banner']); ?>
...
<div class="card-header border-0 pt-6">
	...
	<div class="card-toolbar">
		...
		<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
			...
			<a href="<?php echo e(url('new/banner')); ?>" class="btn btn-primary">
    ...
    <tbody class="text-gray-800">
        ...
        <?php $count++; ?>
            <tr>
                ...
                <td><?php echo e($item->filename??$item->link); ?></td>
                <td><?php echo e($item->status_id); ?></td>
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/edit/'.$item->id.'/banner')); ?>" class="menu-link px-3">
                                Edit
                            </a>
                        </div>
                        <!--end::Menu item-->
            ...
            o.querySelectorAll('[data-kt-user-table-filter="delete_row"]').forEach((t => {
            	t.addEventListener("click", (function(t) {
                    ...
                    Swal.fire({
                    	...
                    	t.value ? ($.ajax({
								type: 'POST',
							    url: "<?php echo e(url('')); ?>/destroy/"+id+"/banner",
							}),
...
<?php endif; ?><?php /**PATH /var/www/html/mytgp/resources/views/secretariat/banner.blade.php ENDPATH**/ ?>
...
<?php echo Form::model($scv, array('route' => ['add.talentscv'], 'method'=>'POST', 'id'=>'kt_add_course_form')); ?>	 
...
<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
	...
	<div class="card card-flush py-4">
		...
		<div class="card-body">
			...
			<h3 class="mb-5 fs-4"><li><?php echo e($item->title); ?></li></h3>
			...
			<div class="mb-10 fv-row ms-5 me-20">
				<!--begin::Label-->
				<label class="required form-label"><?php echo $sub->q; ?></label>
				<!--end::Label-->
				<!--begin::Input-->
				<?php echo Form::textarea('q[]', $scv->$q??'',['class'=>'form-control form-control-solid rounded-2','rows'=>3 ,$disabled,'placeholder'=>$sub->example]); ?>
...
<?php endif; ?><?php /**PATH /var/www/html/mytgp/resources/views/talent/structure-cv.blade.php ENDPATH**/ ?>
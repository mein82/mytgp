...
<div class="card-header border-0 pt-6">
	...
	<div class="card-toolbar">
		...
		<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
			...
			<a href="<?php echo e(url('new/publication')); ?>" class="btn btn-primary">
			...
			<!--end::Svg Icon-->Add Publication</a>	
			</div>
			<!--end::Menu wrapper-->
			<!--end::Export-->
		</div>
    ...
    <tbody class="text-gray-800">
        ...
        <?php $count++; ?>
            <tr>
                ...
                <td><a href="<?php echo e(url('web/'.$item->filename)); ?>" target="_blank"><?php echo e($item->title); ?></a></td>
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/edit/'.$item->id.'/publication')); ?>" class="menu-link px-3">
                                Edit
                            </a>
                        </div>
                        <!--end::Menu item-->
            ...
            o.querySelectorAll('[data-kt-user-table-filter="delete_row"]').forEach((t => {
            	t.addEventListener("click", (function(t) {
                    ...
                    Swal.fire({
                    	...
                    	t.value ? ($.ajax({
								type: 'POST',
							    url: "<?php echo e(url('')); ?>/destroy/"+id+"/publication",
							}),
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/publication.blade.php ENDPATH**/ ?>
...
<div class="d-flex flex-wrap flex-stack pt-10 pb-8">
	...
	<div class="d-flex flex-wrap my-1">
		...
		<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true">
			...
			<!--end::Menu separator-->
			<?php echo Form::open(array('route' => ['reset.talenttwer'], 'method'=>'DELETE')); ?>
			...
			<div class="fv-row mb-10">
				<div class="d-flex flex-column rounded-3 p-7 border border-dashed border-gray-400 bg-light-warning">
					...
					<!-- <div class="separator separator-dashed mb-7"></div> -->
						<div id="kt_slider_basic" class="mt-3"></div>
						<div class="pt-5">
						...
						<div class="d-flex justify-content-end">
					<!--begin::Button-->
					<button type="submit" id="kt_add_mark_submit" class="btn btn-sm btn-primary <?php if(!$talent->twer1): ?> disabled <?php endif; ?>">
		...
		<div class="d-flex flex-column flex-xl-row">
			...
			<div class="fv-row mb-10">
				<div class="d-flex flex-column rounded-3 p-7 border border-dashed border-gray-400 bg-light-warning">
					...
					<!-- <div class="separator separator-dashed mb-7"></div> -->
						<div id="kt_slider_basic2" class="mt-3"></div>
						<div class="pt-5">
						...
						<div class="d-flex justify-content-end">
					<!--begin::Button-->
					<button type="submit" id="kt_add_mark_submit2" class="btn btn-sm btn-primary <?php if(!$talent->twer2): ?> disabled <?php endif; ?>">
						<span class="indicator-label">Submit</span>
						<span class="indicator-progress">Please wait...
						<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
					</button>
...
<?php if(Auth::user()->group_id==6 || Auth::user()->supervisor->count()>0): ?>
	...
	slider.noUiSlider.on("update", function (values, handle) {
		var range_text = '';
		document.querySelector("[name='mark']").value = values[handle];
		if(values[handle]<10)
	...
	slider2.noUiSlider.on("update", function (values, handle) {
		var range_text = '';
		document.querySelector("[name='mark2']").value = values[handle];
		if(values[handle]<10)
			range_text = 'Room for improvement';
		else if(values[handle]>=10 && values[handle]<20)
			range_text = 'Satisfactory';
...
<?php /**PATH /var/www/html/mytgp/resources/views/twer.blade.php ENDPATH**/ ?>
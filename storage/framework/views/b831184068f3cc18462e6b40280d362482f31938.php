...
<!--end::Access menu-->
<td class="text-end"><button type="button" class="btn btn-light-danger btn-icon remove_super" id="kt_button_1" data-id="<?php echo e($item->id); ?>">
...
<?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/selected-user-list.blade.php ENDPATH**/ ?>
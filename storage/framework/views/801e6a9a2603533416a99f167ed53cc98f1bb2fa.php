...
<?php echo Form::model($course, array('route' => ['update.course', $course->id], 'method'=>'PATCH', 'id' => 'kt_add_course_form')); ?>
	...
	<div class="card-body pt-0">
		...
		<div class="row g-9 mb-7">
			...
			<div class="col-md-4 fv-row">
				...
				<!--end::Label-->
				<!--begin::Input-->
				<?php echo Form::select('type_id', $type, null, ['class'=>'form-select form-select-solid fw-bolder','title'=>'Choose','data-control'=>'select2', 'aria-label' =>'', 'placeholder'=>'Select...', 'data-hide-search'=>'true', 'data-allow-clear'=>'true' ]); ?>
			...
			<div class="col-md-4 fv-row">
				...
				<!--end::Label-->
				<!--begin::Input-->
				<?php echo Form::select('platform_id', [1=>'Physical','2'=>'Online'], null, ['class'=>'form-select form-select-solid fw-bolder','title'=>'Choose','data-control'=>'select2', 'aria-label' =>'', 'placeholder'=>'Select...', 'data-hide-search'=>'true', 'data-allow-clear'=>'true' ]); ?>

				<!--end::Input-->
			</div>
			<!--end::Col-->
			<!--begin::Col-->
			<div class="col-md-4 fv-row domain <?php if($course->type_id>1): ?> d-none <?php endif; ?>">
				<!--begin::Label-->
				<label class="fs-6 fw-bold mb-2">
				...
				<!--end::Label-->
				<!--begin::Input-->
				<?php echo Form::select('domain_id', $domain, null, ['class'=>'form-select form-select-solid fw-bolder','title'=>'Choose','data-control'=>'select2', 'aria-label' =>'', 'placeholder'=>'Select...', 'data-hide-search'=>'true', 'data-allow-clear'=>'true' ]); ?>
		...
		<div class="d-flex flex-column mb-7 fv-row">
			...
			<!--end::Label-->
			<?php echo Form::textarea('remark',null,['class'=>'form-control form-control-solid rounded-3','rows'=>3 ]); ?>
		...
		<div class="py-2">
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex justify-content-end">
					<div class="form-check form-check-solid form-switch">
						<?php echo Form::checkbox('food_id',1 ,null,['class'=>'form-check-input w-45px h-30px','id'=>'food' ]); ?>
			...
			<div class="d-flex flex-stack">
				...
				<div class="d-flex justify-content-end">
					<div class="form-check form-check-solid form-switch">
						<?php echo Form::checkbox('accomodation_id',1 ,null,['class'=>'form-check-input w-45px h-30px','id'=>'accomodation' ]); ?>
...
<?php endif; ?><?php /**PATH /var/www/html/mytgp/resources/views/secretariat/training-edit.blade.php ENDPATH**/ ?>
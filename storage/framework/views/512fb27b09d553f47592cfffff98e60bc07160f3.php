                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3 text-start">
                            <a href="<?php echo e(url('/talent/achievement/'.$item->id)); ?>" class="menu-link px-3">
                                Achievement Report
                            </a>
                        </div>
                        <!--end::Menu item-->
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/talent-profile.blade.php ENDPATH**/ ?>
    ...
    <body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative">
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="mb-10" id="home">
                <!--begin::Wrapper-->
                <div class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom" style="background: url(<?php echo e(url('main-1.jpg')); ?>);background-blend-mode: darken;background-size:cover;background-position:center 80%">
                    <!--begin::Header-->
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center flex-equal">
                                    ...
                                    <a href="<?php echo e(url('')); ?>">
                                        <img alt="Logo" src="<?php echo e(url('logo/mytgp-logo.png')); ?>" class="logo-default h-60px" />
                                        <img alt="Logo" src="<?php echo e(url('logo/mytgp-logo.png')); ?>" class="logo-sticky h-60px" />
                                    </a>
                                    <!--end::Logo image-->
                                </div>
                                <!--end::Logo-->
                                ...
                                <div class="flex-equal text-end ms-1">
                                    <a href="<?php echo e(url('login')); ?>" class="btn btn-danger fs-3">Sign In</a>
                                </div>
                                <!--end::Toolbar-->
                            </div>
                            <!--end::Wrapper-->
                    ...
                    <div class="d-flex flex-column flex-center w-100 min-h-400px min-h-lg-600px px-9">
                        ...
                        <!-- <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                            ...
                            <a href="<?php echo e(url('register')); ?>" class="btn btn-danger">Register Now</a>
                        </div> -->
                        <!--end::Heading-->
                    ...
                    <div class="tns tns-default">
                        ...
                        <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="1" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev1" data-tns-next-button="#kt_team_slider_next1">
                            ...
                            <div class="text-end mb-5 mb-lg-10 py-10 py-lg-20">
                                ...
                                <a href="<?php echo e(url('register')); ?>" class="btn btn-danger fs-3">Apply Now</a>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="text-center overlay">
                                <img src="<?php echo e(($item->filename!='')?url('web/'.$item->filename):$item->link); ?>" class="card-rounded shadow mw-100" alt="" />
                                <?php if($item->link_lable==''): ?> <a href="<?php echo e($item->url); ?>" target="_blank"> <?php endif; ?>
                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                    <?php if($item->link_lable!=''): ?><a href="<?php echo e($item->url); ?>" class="btn btn-primary"><?php echo e($item->link_lable); ?></a><?php endif; ?>
                                </div>
                                <?php if($item->link_lable==''): ?> </a><?php endif; ?>
                            </div>
                            <!--end::Item-->
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <!--end::Item-->
                            <?php $__currentLoopData = $announce; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <!--begin::Item-->
                            <div class="mb-5 mb-lg-10 py-10 fs-1 fs-sm-5 fs-xs-5">
                                <?php echo $data->content; ?>

                                <?php if(!is_null($data->button)): ?>
                                    <?php
                                    ...
                                    <a href="<?php echo e($b->btn_url); ?>" class="btn btn-danger mt-5 me-2"><?php echo e($b->btn); ?></a>
							        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="container">
                    ...
                    <div class="row w-100 gy-10 mb-md-20">
                        ...
                        <div class="col-md-4 px-5">
                            ...
                            <div class="text-center mb-10 mb-md-0">
                                <!--begin::Illustration-->
                                <img src="<?php echo e(url('')); ?>/web/scope1.png" class="mh-125px mb-9" alt="" />
                                <!--end::Illustration-->
                                <!--begin::Heading-->
                        ...
                        <div class="col-md-4 px-5">
                            ...
                            <div class="text-center mb-10 mb-md-0">
                                <!--begin::Illustration-->
                                <img src="<?php echo e(url('')); ?>/web/scope2.png" class="mh-125px mb-9" alt="" />
                                <!--end::Illustration-->
                                <!--begin::Heading-->
                                <div class="d-flex flex-center mb-5">
                                    <!--begin::Badge-->
                        ...
                        <div class="col-md-4 px-5">
                            ...
                            <div class="text-center mb-10 mb-md-0">
                                <!--begin::Illustration-->
                                <img src="<?php echo e(url('')); ?>/web/scope3.png" class="mh-125px mb-9" alt="" />
                                <!--end::Illustration-->
                                <!--begin::Heading-->
                                <div class="d-flex flex-center mb-5">
                                    <!--begin::Badge-->
                    ...
                    <div class="tns tns-default">
                        ...
                        <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000" data-tns-autoplay="true" data-tns-autoplay-timeout="18000" data-tns-controls="true" data-tns-nav="false" data-tns-items="3" data-tns-center="false" data-tns-dots="false" data-tns-prev-button="#kt_team_slider_prev3" data-tns-next-button="#kt_team_slider_next3">
                            <?php $__currentLoopData = $publication; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($item->image!=''): ?>
                            <!--begin::Item-->
                            <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                                <div class="overlay">
                                <img src="<?php echo e(url('web/'.$item->image)); ?>" class="card-rounded shadow mw-100" alt="" />
                                <a href="<?php echo e(url('web/'.$item->filename)); ?>"><div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex flex-center">
                            ...
                            <div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-1000px">
                                <!--begin::Item-->
                                <div class="d-flex flex-column flex-center h-150px w-150px h-lg-225px w-lg-225px m-3 bgi-no-repeat bgi-position-center bgi-size-contain" style="background-image: url('<?php echo e(url('')); ?>/assets/media/svg/misc/octagon.svg')">
                                    <!--begin::Symbol-->
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6 ">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium22023-1.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium22023-1.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium22023-2.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium22023-2.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                            ...
                                            <!--end::Row-->
                                            <!--begin::Item-->
                                            <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium22023-6.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium22023-6.jpg')"></div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                    <i class="bi bi-eye-fill fs-3x text-white"></i>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium22023-3.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium22023-3.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium22023-4.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium22023-4.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                            ...
                                            <!--end::Row-->
                                             <!--begin::Item-->
                                             <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium22023-5.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium22023-5.jpg')"></div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                    <i class="bi bi-eye-fill fs-3x text-white"></i>
                                            ...
                                            <!--end::Item-->
                                             <!--begin::Item-->
                                             <a class="d-block card-rounded overlay mt-10" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium22023-7.jpg">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium22023-7.jpg')"></div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                    <i class="bi bi-eye-fill fs-3x text-white"></i>
                                ...
                                <div class="tab-pane fade" id="kt_landing12022">
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            <!--begin::Item-->
                                            <a class="d-block card-rounded overlay h-lg-100" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 1 2022-3.png">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 1 2022-3.png')"></div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                    <i class="bi bi-eye-fill fs-3x text-white"></i>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 1 2022-4.png">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 1 2022-4.png')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 1 2022-2.png">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 1 2022-2.png')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                            ...
                                            <!--end::Row-->
                                            <!--begin::Item-->
                                            <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 1 2022-1.png">
                                                <!--begin::Image-->
                                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 1 2022-1.png')"></div>
                                                <!--end::Image-->
                                                <!--begin::Action-->
                                                <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                    <i class="bi bi-eye-fill fs-3x text-white"></i>
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6 ">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-4.jpeg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-4.jpeg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-5.jpeg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-5.jpeg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-2.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-2.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-3.jpeg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-3.jpeg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                            ...
                                            <!--end::Row-->
                                                    ...
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-1.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/TGP INSPIRATIONAL LEADERSHIP PODIUM 2 2022-1.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                    ...
                                    <div class="row g-10">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-12">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium 1 2023 1.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium 1 2023 1.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                                ...
                                                <div class="col-lg-12">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium 1 2023 2.png">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium 1 2023 2.png')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium 1 2023 3.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium 1 2023 3.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                                ...
                                                <div class="col-lg-6">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium 1 2023 4.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium 1 2023 4.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                            ...
                                            <div class="row g-10 mb-10">
                                                ...
                                                <div class="col-lg-12">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium 1 2023 5.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium 1 2023 5.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
                                                ...
                                                <div class="col-lg-12">
                                                    <!--begin::Item-->
                                                    <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects" href="<?php echo e(url('')); ?>/web/Podium 1 2023 6.jpg">
                                                        <!--begin::Image-->
                                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px" style="background-image:url('<?php echo e(url('')); ?>/web/Podium 1 2023 6.jpg')"></div>
                                                        <!--end::Image-->
                                                        <!--begin::Action-->
                                                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                                            <i class="bi bi-eye-fill fs-3x text-white"></i>
						...
						<div class="d-flex flex-column container pt-lg-20">
							...
							<div class="" id="kt_pricing">
                                <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                                    ...
                                    <?php $f = 0; ?>
                                    <?php $__currentLoopData = $faq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php $f++; ?>
                                    <!--begin:::Tab item-->
										<li class="nav-item">
											<a class="nav-link text-active-primary pb-4 <?php if($f==1): ?> active <?php endif; ?>" data-bs-toggle="tab" href="#kt_faq<?php echo e($tab->id); ?>"><?php echo e($tab->title); ?></a>
										</li>
										<!--end:::Tab item-->
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php $f = 0; ?>
									...
									<?php $f++; ?>
									<!--begin::Tab pane-->
									<div class="tab-pane fade <?php if($f==1): ?> active show <?php endif; ?>" id="kt_faq<?php echo e($tab->id); ?>" role="tab-panel">
                                        <!--begin::Row-->
								<div class="row g-10">
									<!--begin::Col-->
									<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Heading-->
                                            <div class="d-flex align-items-center collapsible py-3 toggle <?php if($c>1): ?> collapsed <?php endif; ?> mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_<?php echo e($content->id); ?>">
                                                <!--begin::Icon-->
                                                ...
                                                <!--end::Icon-->
                                                <!--begin::Title-->
                                                <h4 class="text-gray-300 fw-bolder cursor-pointer mb-0"><?php echo e($content->question); ?></h4>
                                                <!--end::Title-->
                                            </div>
                                            <!--end::Heading-->
                                            <!--begin::Body-->
                                            <div id="kt_job_4_<?php echo e($content->id); ?>" class="collapse <?php if($c==1): ?> show <?php endif; ?> fs-4 ms-1">
                                                <!--begin::Text-->
                                                <div class="mb-4 text-white fw-bold fs-4 ps-10"><?php echo $content->answer; ?></div>
                                                <!--end::Text-->
                                            </div>
                                            <!--end::Content-->
                                            <!--begin::Separator-->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="d-flex flex-column justify-content-between h-lg-100 px-10 px-lg-0 pe-lg-10 mb-15 mb-lg-0">
                                ...
                                <div class="mb-7">
                                    ...
                                    <!--end::Rating-->
                                    <!--begin::Title-->
                                    <div class="fs-3 fw-bolder text-dark mb-3"><?php echo e($item->quote); ?></div>
                                    <!--end::Title-->
                                    <!--begin::Feedback-->
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="<?php echo e(url('alumni/'.$item->photo)); ?>" class="" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <div class="flex-grow-1">
                                        <a href="#" class="text-dark fw-bolder text-hover-primary fs-4"><?php echo e($item->name); ?></a>
                                        <span class="text-muted d-block fw-bold fs-5"><?php echo e($item->position); ?></span>
                                    </div>
                                    <!--end::Name-->
                                </div>
                                <!--end::Author-->
                                    ...
                                    <div class="my-3">
                                        ...
                                        <div class="d-flex flex-row mb-7">
                                            ...
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label d-flex flex-column flex-center bgi-no-repeat bgi-position-y-bottom" style="background-position-y: bottom;background-image: url('<?php echo e(url('web/'.$item->image)); ?>')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <?php endif; ?>
                                            <!--begin::Title-->
                                            <div class="m-0">
                                                <a href="<?php echo e(url('web/'.$item->filename)); ?>" target="_blank" class="text-white fw-bolder text-hover-primary fs-3"><?php echo e($item->title); ?></a>
                                                <span class="text-gray-600 fw-bold d-block pt-1 fs-4"><?php echo e($item->description); ?></span>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<path opacity="0.3" d="M22 9.72498V20.725C22 21.325 21.6 21.725 21 21.725H3C2.4 21.725 2 21.325 2 20.725V9.72498L11.4 17.225C11.8 17.525 12.3 17.525 12.6 17.225L22 9.72498ZM15 11.725H18L14 7.72498V10.725C14 11.325 14.4 11.725 15 11.725Z" fill="black"/>
        ...
        <!-- <script src="<?php echo e(url('')); ?>/assets/plugins/custom/typedjs/typedjs.bundle.js"></script> -->
        <!--end::Page Vendors Javascript-->
        <!--begin::Page Custom Javascript(used by this page)-->
        <script src="<?php echo e(url('')); ?>/assets/js/custom/landing.js"></script>
        <!-- <script src="<?php echo e(url('')); ?>/assets/js/custom/pages/pricing/general.js"></script> -->
    ...
    <!--end::Body-->
</html><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/welcome.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('css', null, []); ?> 
        <link href="<?php echo e(url('')); ?>/css/flag-icon.css" rel="stylesheet" type="text/css" />
     <?php $__env->endSlot(); ?>
<div class="row">
    ...
    <ul class="my-news-ticker">
        <?php $check = false;  ?>
                <?php $__currentLoopData = $notify; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    ?>
                    <?php if($check): ?>
                        <li><a href="javascript:;" data-bs-toggle="modal" data-id="<?php echo e($item->id); ?>" data-bs-target="#kt_modal_view_noti" class="fs-5 fw-bold mb-2 text-dark text-hover-success"><?php echo e($item->title); ?></a>
                    <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <?php if(!$check): ?>  No new notification today. <?php endif; ?>
...
<div class="row g-5">
    <?php if($dashboard=="supervisor" || Auth::user()->group_id==6 || $dashboard=="referee" || Auth::user()->group_id==4): ?>
    <?php if($dashboard=="supervisor" || (Auth::user()->group_id==6 && $dashboard=="")): ?>
     <div class="col-lg-4">
        <div class="row"> 
            <div class="col-12">
                <a href="<?php echo e(url('supervisor/talents')); ?>" class="card mb-5" style="background-color: #7239EA;">
                <!--begin::Body-->
                        ...
                        <div class="tab-content pt-5" id="myTabContent">
                            <div class="tab-pane fade show active" id="kt_tab_todo" role="tabpanel">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <a href="<?php echo e(url('supervisor/talents/tgp-competency-matrix-assessment')); ?>">
                                    ...
                                    <!--begin::Text-->
                                    <div class="d-flex flex-column">
                                        <a href="<?php echo e(url('supervisor/talents/tgp-competency-matrix-assessment')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">TGP Competency Matrix Assessment</a>
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <a href="<?php echo e(url('supervisor/talents/twer')); ?>">
                                        <div class="symbol symbol-50px me-5">
                                    ...
                                    <!--begin::Text-->
                                    <div class="d-flex flex-column">
                                        <a href="<?php echo e(url('supervisor/talents/twer')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Talent Workplace Experience Report (TWER)</a>
                                        <!-- <span class="text-muted fw-bold fs-7">Update your latest info.</span> -->
                                    </div>
                                    <!--end::Text-->
                                </div>
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    <!--begin::Symbol-->
                                    <a href="<?php echo e(url('supervisor/talents/project-progress')); ?>">
                                        <div class="symbol symbol-50px me-5">
                                    ...
                                    <!--begin::Text-->
                                    <div class="d-flex flex-column">
                                        <a href="<?php echo e(url('supervisor/talents/project-progress')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Project Progress</a>
                                        <!-- <span class="text-muted fw-bold fs-7">Update your latest info.</span> -->
                                    </div>
                                    <!--end::Text-->
                                </div>
                            ...
                            <div class="tab-pane fade" id="kt_tab_toknow" role="tabpanel">
                                <?php $__currentLoopData = $thingstoknow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex align-items-sm-center mb-7">
                                    <!--begin::Symbol-->
                                     <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <div class="symbol-label">
                                        <img src="<?php echo e(url('thingstoknow/'.$item->image)); ?>" alt="<?php echo e($item->title); ?>" class="w-100">
                                    </div>
                                </div>
                                <!-- <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-color: #98fbd1 ; background-size: 70% auto;  background-image: url('<?php echo e(url('thingstoknow/'.$item->image)); ?>')"></div>
                                            </div> -->
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        <div class="flex-grow-1 me-2">
                                            <a href="<?php echo e(url('thingstoknow/'.$item->url)); ?>" class="text-gray-800 fw-bolder text-hover-primary fs-6" target="_blank"><?php echo e($item->title); ?></a>
                                        </div>
                                    </div>
                                    <!--end::Title-->
                                </div>
        ...
        <div class="card card-stretch mb-5">
            ...
            <div class="card-header pt-5">
                ...
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder text-dark">TGP Calendar <?php echo e(date("Y")); ?></span>
                </h3>
                <!--end::Card title-->
            </div>
            <!--end::Card header-->
            ...
            <div class="card-body p-5">
                ...
                <ul class="nav nav-pills d-flex flex-nowrap hover-scroll-x ">
                    ...
                    <?php for($i = 1; $i<=12; $i++): ?>
                    <li class="nav-item me-1">
                        <a class="nav-link btn d-flex flex-column <?php if(date('m')==$i): ?> bg-light-primary <?php endif; ?> flex-center rounded-pill min-w-45px me-2 py-4 px-3 btn-active-primary" data-bs-toggle="tab" href="#kt_schedule_day_<?php echo e($i); ?>">
                            <span class="opacity-50 fs-7 fw-bold"><?php echo e(date("M", mktime(0, 0, 0, $i, 10))); ?></span>
                            <span class="fs-6 fw-bolder"><?php echo e(date("m", mktime(0, 0, 0, $i, 10))); ?></span>
                        </a>
                    </li>
                    <?php endfor; ?>
                </ul>
                ...
                <div class="tab-content hover-scroll-y pt-5" id="myCalendar">
                    ...
                    <!--begin::Day-->
                    <div class="<?php if(date("mY",strtotime($item->start_date))==date("mY")): ?>bg-light-primary <?php endif; ?> py-5">
                        <!--begin::Time-->
                        <div class="d-flex flex-stack position-relative">
                            <!--begin::Bar-->
                            <div class="position-absolute h-100 w-4px <?php echo e($item->type->color->name??'bg-gray-300'); ?> rounded top-0 start-0"></div>
                            <!--end::Bar-->
                            <!--begin::Info-->
                            <div class="fw-bold ms-5 text-gray-600">
                                <!--begin::Time-->
                                <div class="fs-7"><?php echo e(date("d M Y",strtotime($item->start_date))); ?> - <?php echo e(date("d M Y",strtotime($item->end_date))); ?>

                                </div>
                                <!--end::Time-->
                                <!--begin::Title-->
                                <a href="#" class="fs-6 fw-bold text-gray-800 mb-2"><?php echo e($item->type->name??''); ?> : <?php echo e($item->title); ?></a><br/>
                                <a href="#" class="fs-7 text-gray-800"><?php echo e($item->domain->name??''); ?></a>
                                <!--end::Title-->
                            </div>
                            <!--end::Info-->
                        </div>
                ...
                <?php for($i = 1; $i<=12; $i++): ?>
                <div class="tab-pane fade" id="kt_schedule_day_<?php echo e($i); ?>" >
                    <?php $__currentLoopData = App\Models\Courses::monthly($i)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <!--begin::Day-->
                    <div class="">
                        <!--begin::Time-->
                        <div class="d-flex flex-stack position-relative">
    ...
    <div class="col-lg-4">
        ...
        <div class="card card-stretch mb-5">
            ...
            <div class="card-body px-10">
                ...
                <?php echo $tor->where('group_id',6)->first()->content??''; ?>

                </div>
            </div>
        </div>
    </div>
    <?php elseif($dashboard=="referee" || (Auth::user()->group_id==4  && $dashboard=="")): ?>
     <div class="col-lg-6">
        <div class="row"> 
            <div class="col-12">
                <a href="<?php echo e(url('referee/recommendation')); ?>" class="card h-125px mb-5" style="background-color: #4AB58E;">
                <!--begin::Body-->
                <div class="card-body d-flex flex-column justify-content-between">
                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                    <span class="svg-icon svg-icon-white svg-icon-2hx ms-n1 flex-grow-1">
        ...
        <div class="card  card-stretch mb-5">
            ...
            <div class="card-header border-0 py-5">
                ...
                <!-- <div class="card-title flex-column">
                    ...
                    <div class="fs-6 text-gray-400">Total <?php echo e($applicants->count()); ?> applicants and <?php echo e($talents->count()); ?> talents</div>
                </div> -->
                <!--end::Card title-->
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="kt_table_widget_5_tab_1">
                        ...
                        <div class="card-px pb-10 flex-grow-1">
                            ...
                            <div class="row g-0 mt-5 mb-10">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-applicant" search-programme="MEDICAL">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder"  data-kt-countup="true" data-kt-countup-value="<?php echo e($applicants->where('applicant.programme_id',1)->count()); ?>">0</div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-applicant" search-programme="PUBLIC HEALTH">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($applicants->where('applicant.programme_id',2)->count()); ?>">0</div>
                            ...
                            <div class="row g-0 mb-10">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-applicant" search-programme="RESEARCH & TECHNICAL SUPPORT">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($applicants->where('applicant.programme_id',3)->count()); ?>">0</div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-applicant" search-programme="ORAL HEALTH">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($applicants->where('applicant.programme_id',4)->count()); ?>">0</div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-applicant" search-programme="PHARMACEUTICAL SERVICES">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($applicants->where('applicant.programme_id',5)->count()); ?>">0</div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-applicant" search-programme="FOOD SAFETY & QUALITY">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($applicants->where('applicant.programme_id',6)->count()); ?>">0</div>
                            ...
                            <!--end::Row-->
                            <div class="fs-7 text-muted fw-bolder mt-5 text-end">Total: <span class="text-dark fs-4"><?php echo e($applicants->count()); ?></span></div>
                        </div>
                        <!--end::Stats-->
                    </div>
                    <!--end::Tap pane-->
                        ...
                        <div class="card-px pb-10 flex-grow-1 row">
                                ...
                                <div class="d-flex align-items-center col-6 border-bottom-dotted p-1 border-gray-300">
                                    <div class="symbol symbol-45px me-5">
                                        <span class="h-25px w-50px malaysia-state-flag-icon malaysia-state-flag-icon-<?php echo e($state->ext); ?>"></span>
                                    </div>
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="#" class="text-dark fw-bolder text-hover-primary fs-6 search-state" search-state="<?php echo e($state->name); ?>"><?php echo e($applicants->where('applicant.office_state',$state->id)->count()); ?></a>
                                        <span class="text-muted fw-bold text-muted d-block fs-9"><?php echo e($state->name); ?></span>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="row g-0 mt-5 mb-10">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-programme="MEDICAL">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->where('programme_id',1)->count()); ?>">0</div>
                                            <div class="fs-7 text-muted fw-bold">Medical</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-programme="PUBLIC HEALTH">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->where('programme_id',2)->count()); ?>">0</div>
                                            <div class="fs-7 text-muted fw-bold">Public Health</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                            ...
                            <div class="row g-0 mb-10">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-programme="RESEARCH & TECHNICAL SUPPORT">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->where('programme_id',3)->count()); ?>">0</div>
                                            <div class="fs-7 text-muted fw-bold">Research & Technical..</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-programme="ORAL HEALTH">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->where('programme_id',4)->count()); ?>">0</div>
                                            <div class="fs-7 text-muted fw-bold">Oral Health</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-programme="PHARMACEUTICAL SERVICES">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->where('programme_id',5)->count()); ?>">0</div>
                                            <div class="fs-7 text-muted fw-bold">Pharmaceutical Services</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-programme="FOOD SAFETY & QUALITY">
                                        ...
                                        <!--begin::Title-->
                                        <div>
                                            <div class="fs-6 text-dark fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->where('programme_id',6)->count()); ?>">0</div>
                                            <div class="fs-7 text-muted fw-bold">Food Safety & Quality</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-status="Active">
                                        ...
                                        <div>
                                            ...
                                            <div class="fs-7 text-muted fw-bold"><?php echo e($talents->where('status.final_id',1)->count()); ?> : <span class="text-success fs-7 fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->count()>0?round($talents->where('status.final_id',1)->count()/$talents->count()*100):0); ?>" data-kt-countup-suffix="%">0</span></div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-status="Alumni">
                                        ...
                                        <div>
                                            ...
                                            <div class="fs-7 text-muted fw-bold"><?php echo e($talents->where('status.final_id',2)->count()); ?> : <span class="text-warning fs-7 fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->count()>0?round($talents->where('status.final_id',2)->count()/$talents->count()*100):0); ?>" data-kt-countup-suffix="%">0</span></div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-status="Study Leave">
                                        ...
                                        <div>
                                            ...
                                            <div class="fs-7 text-muted fw-bold"><?php echo e($talents->where('status.final_id',4)->count()); ?> : <span class="text-info fs-7 fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->count()>0?round($talents->where('status.final_id',4)->count()/$talents->count()*100):0); ?>" data-kt-countup-suffix="%">0</span></div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="d-flex align-items-center me-2 cursor-pointer search-talent" search-status="Dropout">
                                        ...
                                        <div>
                                            ...
                                            <div class="fs-7 text-muted fw-bold"><?php echo e($talents->where('status.final_id',3)->count()); ?> : <span class="text-danger fs-7 fw-bolder" data-kt-countup="true" data-kt-countup-value="<?php echo e($talents->count()>0?round($talents->where('status.final_id',3)->count()/$talents->count()*100):0); ?>" data-kt-countup-suffix="%">0</span></div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                </div>
...
<li class="nav-item mt-2">
                ...
                <div class="tab-content pt-5" id="myTabContent">
                    <div class="tab-pane fade show active" id="kt_tab_todo" role="tabpanel">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            <!--begin::Symbol-->
                            <a href="<?php echo e(url('panel/applicants')); ?>">
                                <div class="symbol symbol-50px me-5">
                                <span class="symbol-label bg-light-success">
                                    <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                    <span class="svg-icon svg-icon-2x svg-icon-success">
...
<rect opacity="0.3" x="6" y="5" width="6" height="6" rx="3" fill="black"/>
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php echo e(url('panel/applicants')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Applicants Evaluation</a>
                                <!-- <span class="text-muted fw-bold fs-7">Update your latest info.</span> -->
                            </div>
                            <!--end::Text-->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            <!--begin::Symbol-->
                            <a href="<?php echo e(url('panel/talents')); ?>">
                                <div class="symbol symbol-50px me-5">
                                <span class="symbol-label bg-light-danger">
                                    <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                    <span class="svg-icon svg-icon-2x svg-icon-danger">
...
<rect opacity="0.3" x="6" y="5" width="6" height="6" rx="3" fill="black"/>
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php echo e(url('panel/ars')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Application Ranking System</a>
                                <!-- <span class="text-muted fw-bold fs-7">Update your latest info.</span> -->
                            </div>
                            <!--end::Text-->
                        </div>
...
<rect opacity="0.3" x="6" y="5" width="6" height="6" rx="3" fill="black"/>
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php echo e(url('panel/talents')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Talent Evaluation</a>
                                <!-- <span class="text-muted fw-bold fs-7">Update your latest info.</span> -->
                            </div>
                            <!--end::Text-->
                        </div>
        ...
        <?php if(!$applicant || checktask($applicant->id)>0): ?>
        ...
        <div class="card card-stretch mb-5 pt-3">
            ...
            <!-- <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    ...
                    <?php if($applicant && checktask($applicant->id)>0): ?><span class="text-muted mt-1 fw-bold fs-7">Pending <?php echo e(checktask($applicant->id)); ?> tasks</span>
                    <?php else: ?>
...
<li class="nav-item mt-2">
                ...
                <div class="tab-content pt-5" id="myTabContent">
                    <div class="tab-pane fade show active" id="kt_tab_todo" role="tabpanel">
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Symbol-->
                            <a href="<?php if(is_null($applicant)): ?><?php echo e(url('e-form')); ?><?php else: ?><?php echo e(url('/edit/e-form/'.$applicant->id)); ?><?php endif; ?>">
                                <div class="symbol symbol-50px me-5">
                                <span class="symbol-label <?php if($applicant): ?> bg-light-success <?php endif; ?>">
                                    <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                    <span class="svg-icon svg-icon-2x <?php if($applicant): ?> svg-icon-success <?php endif; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php if(is_null($applicant)): ?><?php echo e(url('e-form')); ?><?php else: ?><?php echo e(url('/edit/e-form/'.$applicant->id)); ?><?php endif; ?>" class="text-dark text-hover-primary fs-6 fw-bolder">E-Form</a>
                                <?php if($applicant && checkeform($applicant->id,4)): ?><span class="fw-bold text-primary">Completed</span><?php else: ?>
                                <span class="text-muted fw-bold"><span class="<?php if($applicant && checkeform($applicant->id,1)): ?>text-primary <?php endif; ?>">Personal</span>, <span class="<?php if($applicant && checkeform($applicant->id,2)): ?>text-primary <?php endif; ?>">Academic</span>, <span class="<?php if($applicant && checkeform($applicant->id,3)): ?>text-primary <?php endif; ?>">Professional</span>, <span class="<?php if($applicant && checkeform($applicant->id,4)): ?>text-primary <?php endif; ?>">Personal Statement & CPD Log Book</span></span>
                                <?php endif; ?>
                            </div>
                            <!--end::Text-->
                        </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-1 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(($lock || $date<date("Y-m-d")) && ($applicant->scv1->status_id??'')!=1): ?>
                                                        <span class="badge badge-secondary text-hover-gray-800">Enrollment</span>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(url('/talent/structure-cv/1')); ?>" class="badge badge-success text-hover-gray-800">Enrollment</a> 
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end">
                                                    <?php if($lock && ($applicant->scv1->status_id??'')!=1): ?>
                                                        <span class="text-muted fw-bold d-block fs-8">-</span>
                                                    <?php else: ?>
                                                        <?php if(($applicant->scv1->status_id??'')==1): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Completed</span>
                                                        <?php else: ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7"><span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Symbol-->
                            <a href="<?php if($applicant && checkeform($applicant->id,4)): ?><?php echo e(url('applicant/referees')); ?><?php else: ?>#<?php endif; ?>">
                                <div class="symbol symbol-50px me-5">
                                <span class="symbol-label <?php if($applicant && checkeform($applicant->id,4)): ?>bg-light-warning <?php endif; ?>">
                                    <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
                                    <span class="svg-icon svg-icon-2x <?php if($applicant && checkeform($applicant->id,4)): ?>svg-icon-warning <?php endif; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php if($applicant && checkeform($applicant->id,4)): ?><?php echo e(url('applicant/referees')); ?><?php else: ?>#<?php endif; ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Referees</a>
                                <?php if($applicant && checkref($applicant->id,2)): ?>
                                <span class="fw-bold text-primary">Completed</span>
                                <?php else: ?>
                                <span class="text-muted fw-bold"><span class="<?php if($applicant && checkref($applicant->id,1)): ?>text-primary <?php endif; ?>">Recommendation</span>, <span class="<?php if($applicant && checkref($applicant->id,2)): ?>text-primary <?php endif; ?>">Assessment</span></span>
                                <?php endif; ?>
                            </div>
                            <!--end::Text-->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-7">
                            <!--begin::Symbol-->
                            <a href="<?php if($applicant && $applicant->selflog): ?><?php echo e(url('applicant/view/logbook')); ?><?php elseif($applicant && checkref($applicant->id,2)): ?><?php echo e(url('applicant/logbook')); ?><?php else: ?>#<?php endif; ?>">
                                <div class="symbol symbol-50px me-5">
                                <span class="symbol-label <?php if($applicant && checkref($applicant->id,2)): ?>bg-light-primary <?php endif; ?>">
                                    <!--begin::Svg Icon | path: icons/duotune/communication/com012.svg-->
                                    <span class="svg-icon svg-icon-2x <?php if($applicant && checkref($applicant->id,2)): ?>svg-icon-primary <?php endif; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php if($applicant && $applicant->selflog): ?><?php echo e(url('applicant/view/logbook')); ?><?php elseif($applicant && checkref($applicant->id,2)): ?><?php echo e(url('applicant/logbook')); ?><?php else: ?>#<?php endif; ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Self Assessment</a>
                                <span class="fw-bold text-primary"><?php if($applicant && $applicant->selflog): ?> Completed <?php endif; ?></span>
                            </div>
                            <!--end::Text-->
                        </div>
                        <!--end::Item-->
            ...
            <div class="card-body pt-0">
                ...
                <div class="tab-content pt-5" id="myTabContent">
                    <div class="tab-pane fade show active" id="kt_tab_todo" role="tabpanel">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            <!--begin::Symbol-->
                            <a href="<?php echo e(url('/edit/e-form/'.$talent->id)); ?>">
                                <div class="symbol symbol-50px me-5">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php echo e(url('/edit/e-form/'.$talent->id)); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Profile</a>
                                <span class="text-muted fw-bold fs-7">Update your latest info.</span>
                            </div>
                            <!--end::Text-->
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="d-flex flex-column w-100">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-1 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(($lock || $date<date("Y-m-d")) && (Auth::user()->applicant->scv1->status_id??'')!=1): ?>
                                                        <span class="badge badge-secondary text-hover-gray-800">Enrollment</span>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(url('/talent/structure-cv/1')); ?>" class="badge badge-success text-hover-gray-800">Enrollment</a> 
                                                    <?php endif; ?>
                                                ...
                                                <td class="text-end">
                                                    <?php if($lock && (Auth::user()->applicant->scv1->status_id??'')!=1): ?>
                                                        <span class="text-muted fw-bold d-block fs-8">-</span>
                                                    <?php else: ?>
                                                        <?php if((Auth::user()->applicant->scv1->status_id??'')==1): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Completed</span>
                                                        <?php else: ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7"><span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php endif; ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(($lock || $date<date("Y-m-d")) && ($talent->scv2->status_id??'')!=1): ?>
                                                        <span class="badge badge-secondary text-hover-gray-800">End of programme</span>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(url('/talent/structure-cv/2')); ?>" class="badge badge-success text-hover-gray-800">End of programme</a>
                                                    <?php endif; ?>

                                                </td>
                                                <td class="text-end">
                                                    <?php if($lock && ($talent->scv2->status_id??'')!=1): ?>
                                                        <span class="text-muted fw-bold d-block fs-8">-</span>
                                                    <?php else: ?>
                                                        <?php if(($talent->scv2->status_id??'')==1): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Completed</span>
                                                        <?php else: ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7"><span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php endif; ?>
                                ...
                                <!-- <span class="fw-bold text-primary">
                                    <?php if(Auth::user()->locks->where('lock_name','scv-1')->first()): ?> 
                                    <a href="<?php echo e(url('/talent/structure-cv/1')); ?>" class="badge <?php if($talent->scv1->status_id??''==1): ?> badge-secondary <?php else: ?> badge-danger <?php endif; ?> text-hover-gray-800">Early programme</a> 
                                    <?php else: ?>
                                    <span class="text-muted fw-bold fs-7">Early programme entry is locked.</span>
                                    <?php endif; ?>
                                    <?php if(Auth::user()->locks->where('lock_name','scv-2')->first()): ?> 
                                    <a href="<?php echo e(url('/talent/structure-cv/2')); ?>" class="badge <?php if($talent->scv2->status_id??''==1): ?> badge-secondary <?php else: ?> badge-danger <?php endif; ?> text-hover-gray-800">End of Programme</a>
                                    <?php else: ?>
                            ...
                            <div class="d-flex flex-column w-100">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-1 mb-0">
                                        ...
                                        <!--begin::Table body-->
                                        <tbody>
                                            <?php if(($talent->status->cohort??'0')>12): ?>
                                            <tr>
                                                <td>
                                                    <a href="<?php echo e(url('/applicant/view/logbook')); ?>" class="badge badge-success text-hover-gray-800">Baseline</a> 
                                                </td>
                                                <td class="text-end">
                                                   <?php if($talent->user->applicant->selflog): ?>
                                                    <span class="text-gray-700 fw-bolder d-block fs-7">Completed</span>
                                                    <?php else: ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(($lock || $date<date("Y-m-d")) && !$talent->selflog2): ?>
                                                        <span class="badge badge-secondary text-hover-gray-800">1st Year entry</span>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(url('/talent/logbook/2')); ?>" class="badge badge-success text-hover-gray-800">1st Year entry</a> 
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end">
                                                    <?php if($lock && !$talent->selflog2): ?>
                                                        <span class="text-muted fw-bold d-block fs-8">-</span>
                                                    <?php else: ?>
                                                        <?php if($talent->selflog2): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Completed</span>
                                                        <?php else: ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7"><span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php endif; ?>
                                                ...
                                                <td>
                                                    <?php if(is_null($talent->superlog2)): ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(($lock || $date<date("Y-m-d")) && !$talent->selflog3): ?>
                                                        <span class="badge badge-secondary text-hover-gray-800">2nd Year entry</span>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(url('/talent/logbook/3')); ?>" class="badge badge-success text-hover-gray-800">2nd Year entry</a> 
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end">
                                                    <?php if($lock && !$talent->selflog3): ?>
                                                        <span class="text-muted fw-bold d-block fs-8">-</span>
                                                    <?php else: ?>
                                                        <?php if($talent->selflog3): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Completed</span>
                                                        <?php else: ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7"><span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php endif; ?>
                                                ...
                                                <td>
                                                    <?php if(is_null($talent->superlog3)): ?>
                                                        <span class="text-danger fw-bolder d-block fs-7">Not Evaluated</span>
                                                    <?php else: ?>
                                                        <span class="text-success fw-bolder d-block fs-7">Evaluated</span>
                                                    <?php endif; ?>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-1 mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(($lock || $date<date("Y-m-d")) && ($talent->twer1->status_id??'')==""): ?>
                                                        <?php if(is_null($talent->twer1)): ?>
                                                            <span class="badge badge-secondary text-hover-gray-800">1st Year entry</span>
                                                        <?php else: ?>
                                                            <a href="<?php echo e(url('/talent/twer/1')); ?>" class="badge badge-secondary text-hover-gray-800">1st Year entry</a> 
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(url('/talent/twer/1')); ?>" class="badge badge-success text-hover-gray-800">1st Year entry</a> 
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end">
                                                    <?php if($lock && ($talent->twer1->status_id??'')==""): ?>
                                                        <span class="text-muted fw-bold d-block fs-8">-</span>
                                                    <?php else: ?>
                                                        <?php if($talent->twer1 && is_null($talent->twer1->status_id)): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Draft</span> <span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php elseif($talent->twer1 && $talent->twer1->status_id==1): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Completed</span>
                                                        <?php else: ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7"><span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php endif; ?>
                                                ...
                                                <td>
                                                    <?php if($talent->twer1 && is_null($talent->twer1->mark)): ?>
                                                    <span class="text-danger fw-bolder d-block fs-7">Not Evaluated</span>
                                                    <?php elseif($talent->twer1 && !is_null($talent->twer1->mark)): ?>
                                                    <span class="text-success fw-bolder d-block fs-7">Evaluated</span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(($lock || $date<date("Y-m-d")) && ($talent->twer2->status_id??'')==""): ?>
                                                        <?php if(is_null($talent->twer2)): ?>
                                                            <span class="badge badge-secondary text-hover-gray-800">2nd Year entry</span>
                                                        <?php else: ?>
                                                            <a href="<?php echo e(url('/talent/twer/2')); ?>" class="badge badge-secondary text-hover-gray-800">2nd Year entry</a> 
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(url('/talent/twer/2')); ?>" class="badge badge-success text-hover-gray-800">2nd Year entry</a> 
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end">
                                                    <?php if($lock && ($talent->twer2->status_id??'')==""): ?>
                                                        <span class="text-muted fw-bold d-block fs-8">-</span>
                                                    <?php else: ?>
                                                        <?php if($talent->twer2 && is_null($talent->twer2->status_id)): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Draft</span> <span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php elseif($talent->twer2 && $talent->twer2->status_id==1): ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7">Completed</span>
                                                        <?php else: ?>
                                                        <span class="text-gray-700 fw-bolder d-block fs-7"><span class="text-muted fw-bold fs-8">Due by</span> <?php echo e(date("d M, y",strtotime($date))); ?></span>
                                                        <?php endif; ?>
                                                ...
                                                <td>
                                                    <?php if($talent->twer2 && is_null($talent->twer2->mark)): ?>
                                                    <span class="text-danger fw-bolder d-block fs-7">Not Evaluated</span>
                                                    <?php elseif($talent->twer2 && !is_null($talent->twer2->mark)): ?>
                                                    <span class="text-success fw-bolder d-block fs-7">Evaluated</span>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            <!--begin::Symbol-->
                            <a href="<?php echo e(url('/talent/training')); ?>">
                                <div class="symbol symbol-50px me-5">
                                <span class="symbol-label bg-light-danger">
                                    <!--begin::Svg Icon | path: icons/duotune/communication/com012.svg-->
                                    <span class="svg-icon svg-icon-2x svg-icon-danger">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php echo e(url('/talent/training')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Training</a>
                                <span class="text-danger fw-bold"> 
                                    <?php if($talent->course->where('status_id',NULL)->count()>0): ?>
                                    Pending <?php echo e($talent->course->where('status_id',NULL)->count()); ?> response.
                                    <?php endif; ?>
                                </span>
                                <span class="text-gray-600 fw-bold">
                                <span class="text-success"><?php echo e($talent->course->where('attendance_id',4)->count()); ?></span> / <?php echo e($talent->course->count()); ?>
                        ...
                        <div class="d-flex align-items-center mb-5">
                            <!--begin::Symbol-->
                            <a href="<?php echo e(url('/talent/project')); ?>">
                                <div class="symbol symbol-50px me-5">
                                <span class="symbol-label bg-light-primary">
                                    <!--begin::Svg Icon | path: icons/duotune/communication/com012.svg-->
                                    <span class="svg-icon svg-icon-2x svg-icon-primary">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php echo e(url('/talent/project')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Project Progress</a>
                                    <?php 
                                ...
                                <span class="text-<?php echo e(($progress && $totalMonths>6)?'danger':'success'); ?> fw-bold">
                                    <?php echo e(($progress)?date('d/m/Y', strtotime($updated_at)):'-'); ?>
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Symbol-->
                            <a href="<?php echo e(url('/talent/document')); ?>">
                                <div class="symbol symbol-50px me-5">
                            ...
                            <!--begin::Text-->
                            <div class="d-flex flex-column">
                                <a href="<?php echo e(url('/talent/document')); ?>" class="text-dark text-hover-primary fs-6 fw-bolder">Uploaded Documents</a>
    ...
    <!--end::col-4 1st-->
    <?php if(Auth::user()->group_id!=7 && Auth::user()->group_id!=5): ?>
    <div class="col-lg-4">
        <div class="row"> 
            <?php if(Auth::user()->group_id==1 || Auth::user()->group_id==2): ?>  
            <div class="col-6">
                <a href="<?php echo e(url('secretariat/applicants')); ?>" class="card h-125px mb-5">
                <!--begin::Body-->
                <div class="card-body d-flex flex-column justify-content-between">
                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
            ...
            <div class="col-6">
                <a href="<?php echo e(url('secretariat/talents')); ?>" class="card h-125px mb-5" style="background-color: #7239EA;">
                <!--begin::Body-->
                <div class="card-body d-flex flex-column justify-content-between">
                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                    <span class="svg-icon svg-icon-white svg-icon-2hx ms-n1 flex-grow-1">
            ...
            <div class="col-6">
                <a href="<?php echo e(url('secretariat/ars')); ?>" class="card h-125px mb-5 bg-danger">
                <!--begin::Body-->
                <div class="card-body d-flex flex-column justify-content-between">
                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
  ...
  <path class="permanent" d="M14.8563 9.1903C15.0606 8.94984 15.3771 8.9385 15.6175 9.14289C15.858 9.34728 15.8229 9.66433 15.6185 9.9048L11.863 14.6558C11.6554 14.9001 11.2876 14.9258 11.048 14.7128L8.47656 12.4271C8.24068 12.2174 8.21944 11.8563 8.42911 11.6204C8.63877 11.3845 8.99996 11.3633 9.23583 11.5729L11.3706 13.4705L14.8563 9.1903Z" fill="white"/>
            ...
            <div class="col-6">
                <a href="<?php echo e(url('secretariat/supervisors ')); ?>" class="card h-125px mb-5 bg-success">
                <!--begin::Body-->
                <div class="card-body d-flex flex-column justify-content-between">
                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                    <span class="svg-icon svg-icon-secondary svg-icon-2hx ms-n1 flex-grow-1">
...
<rect opacity="0.3" x="6" y="5" width="6" height="6" rx="3" fill="black"/>
            ...
            <div class="col-6">
                <a href="<?php echo e(url('secretariat/project')); ?>" class="card h-125px mb-5" style="background-image:url('assets/media/stock/600x600/img-7.jpg')">
                <!--begin::Body-->
                <div class="card-body d-flex flex-column justify-content-between">
                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                    <span class="svg-icon svg-icon-secondary svg-icon-2hx ms-n1 flex-grow-1">
...
<path opacity="0.3" d="M20 5H4C3.4 5 3 5.4 3 6V17H21V6C21 5.4 20.6 5 20 5Z" fill="black"/>
            ...
            <div class="col-6">
                ...
                <a href="<?php echo e(url('training')); ?>" class="card h-125px bg-primary mb-5">
                    <!--begin::Body-->
                    <div class="card-body d-flex flex-column justify-content-between">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                        <span class="svg-icon svg-icon-white svg-icon-2hx ms-n1 flex-grow-1">
            ...
            <div class="col-6">
                <!--begin::Tiles Widget 5-->
                <a href="<?php echo e(url('secretariat/document')); ?>" class="card h-125px bg-dark mb-5">
                    <!--begin::Body-->
                    <div class="card-body d-flex flex-column justify-content-between">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                        <span class="svg-icon svg-icon-white svg-icon-2hx ms-n1 flex-grow-1">
            ...
            <?php if(Auth::user()->group_id!=7 && Auth::user()->group_id!=5): ?>  
            <!-- <div class="col-6">
                <div class="card h-125px bgi-no-repeat bgi-size-contain mb-5" style="background-color: #663259; background-position: 0 calc(100% + 0.5rem); background-size: 100% auto;  background-image:url('<?php echo e(url('')); ?>/assets/media/svg/misc/taieri.svg')">
                    <div class="card-body d-flex flex-column justify-content-between">
                        <h2 class="text-white fw-bolder mb-5">TGP Booklet
                        </h2>
                        <div class="m-0">
                            <a target="_blank" href="<?php echo e(url('info/BOOKLET_TGP_2018.pdf')); ?>" class="btn btn-danger fw-bold px-6 py-3" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">2018</a>
                        </div>
                    </div>
                </div>
            </div> -->
            <!-- <div class="col-6">
                <div class="card h-125px bgi-no-repeat mb-5" style="background-position: right top; background-size: 40% auto; background-image: url(<?php echo e(url('')); ?>/assets/media/svg/shapes/abstract-4.svg">
                    <div class="card-body">
                        <a target="_blank" href="<?php echo e(url('info/TGP_Guidelines.pdf')); ?>" class="card-title fw-bolder text-muted text-hover-primary fs-2">TGP Guidelines</a>
                    </div>
                </div>
            </div> -->
            <?php endif; ?>
            ...
            <div class="col-12">
                <!--begin::Tiles Widget 5-->
                <a href="<?php echo e(url('applicant/document')); ?>" class="card h-125px bg-dark mb-5">
                    <!--begin::Body-->
                    <div class="card-body d-flex flex-column justify-content-between">
                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                        <span class="svg-icon svg-icon-white svg-icon-2hx ms-n1 flex-grow-1">
    ...
    <div class="col-lg-4">
                    ...
                    <div class="row g-0 mb-10">
                        ...
                        <div class="col">
                            <div class="d-flex align-items-center me-2 cursor-pointer panel-search-applicant" search-status="Complete">
                                ...
                                <!--begin::Title-->
                                <div>
                                    <div class="fs-6 text-dark fw-bolder"><?php echo e($complete); ?></div>
                        ...
                        <div class="col">
                            <div class="d-flex align-items-center me-2 cursor-pointer panel-search-applicant" search-status="Incomplete">
                                ...
                                <!--begin::Title-->
                                <div>
                                    <div class="fs-6 text-dark fw-bolder"><?php echo e($total-$complete); ?></div>
        ...
        <?php endif; ?>
        <?php if(Auth::user()->group_id<=2 || Auth::user()->group_id==7): ?>
        <?php if(Auth::user()->group_id==7): ?>
        ...
        <div class="row g-0 assessment d-none">
            ...
            <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7 border border-gray-300">
                ...
                <!--end::Svg Icon-->
                <a href="<?php echo e(url('/talent/assessment/profile')); ?>" class="text-warning fw-bold fs-6 mt-2">Talent Profile Update</a>
            </div>
            <!--end::Col-->
            <!--begin::Col-->
            <div class="col bg-light-success px-6 py-8 rounded-2 mb-7 border border-gray-300">
                ...
                <!--end::Svg Icon-->
                <a href="<?php echo e(url('/talent/assessment/project')); ?>" class="text-success fw-bold fs-6 mt-2">TGP Project</a>
            </div>
            <!--end::Col-->
        </div>
        <?php endif; ?>
    ...
    <div class="col-lg-4">
        ...
        <div class="card card-stretch mb-5">
            ...
            <div class="card-body px-10">
                <div class=" hover-scroll-y" id="torContent"> 
                <?php echo $tor->where('group_id',7)->first()->content??''; ?>
    ...
    <div class="col-lg-4">
        ...
        <div class="card card-stretch mb-5">
            ...
            <div class="card-body px-10">
                <div class=" hover-scroll-y" id="torContent"> 
                <?php echo $tor->where('group_id',5)->first()->content??''; ?>
...
<script>
<?php if($dashboard=="supervisor" || Auth::user()->group_id==6): ?>
...
toastr.success("Welcome back to MyTGP", hello+" <?php echo e(Auth::user()->name); ?>");
...
<?php endif; ?>
<?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/dashboard.blade.php ENDPATH**/ ?>
    ...
    <tbody class="text-gray-800">
        ...
        <?php $count = 0; ?>
            <tr>
                ...
                <td><?php echo e($item->name); ?><br/><span class="text-gray-700 fs-7"><?php echo e($item->designation); ?></span><br/><span class="text-gray-500 fs-8"><?php echo e($item->organization); ?></span>
                </td>
                ...
                <td>
					<span class="badge badge-<?php echo e(!is_null($item->talent->superlog2)?'success':'warning'); ?>"><?php echo e(!is_null($item->talent->superlog2)?'Completed':'Pending'); ?> 1st Year</span><br/>
					<span class="badge badge-<?php echo e(!is_null($item->talent->superlog3)?'success':'warning'); ?>"><?php echo e(!is_null($item->talent->superlog3)?'Completed':'Pending'); ?> 2nd Year</span>
				</td>
				<td>
					<span class="badge badge-<?php echo e(!is_null($item->talent->twer1)&&!is_null($item->talent->twer1->mark)?'success':'warning'); ?>"><?php echo e(!is_null($item->talent->twer1)&&!is_null($item->talent->twer1->mark)?'Completed':'Pending'); ?> 1st Year</span><br/>
					<span class="badge badge-<?php echo e(!is_null($item->talent->twer2)&&!is_null($item->talent->twer2->mark)?'success':'warning'); ?>"><?php echo e(!is_null($item->talent->twer2)&&!is_null($item->talent->twer2->mark)?'Completed':'Pending'); ?> 2nd Year</span>
				</td>
                <td><div class="badge badge-<?php echo e($item->talent->status->finals->label??'dark'); ?> fw-bolder"><?php echo e($item->talent->status->finals->name??''); ?></div>
                	<div class="d-flex flex-column fs-7">
                	<?php if($item->talent->status->final_id==4): ?>
			         <?php if(!is_null($item->talent->status->study_sdate) && !is_null($item->talent->status->study_edate)): ?>
			         <span><?php echo e(date("d.m.Y",strtotime($item->talent->status->study_sdate))); ?> to <?php echo e(date("d.m.Y",strtotime($item->talent->status->study_edate))); ?></span>
			         <?php endif; ?>
			         <span><?php echo e($item->talent->status->institution); ?></span>
			         <?php endif; ?> 
			         <span><?php echo e($item->talent->status->remark); ?></span>
                	</div>
                </td>
                <td class="d-none">
                	<?php echo e($item->talent->status->final_id); ?>

                	
			     </div>
                </td>
                <td class="text-end">
                    <a href="<?php echo e(url('/supervisor/talent/summary/'.$task.'/'.$item->id)); ?>" class="btn btn-bg-light btn-color-gray-900 btn-active-primary btn-sm"><?php if($task=="project-progress"): ?> Review <?php else: ?> Evaluate <?php endif; ?></a>
                    <!-- <a href="<?php echo e(url('/supervisor/talent/summary/'.$item->id)); ?>" class="btn btn-dark btn-active-light-primary btn-sm">Evaluate</a> -->
                </td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/supervisor/talents-task.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
 ...
 <?php $__env->slot('subheader', null, []); ?> 
    Talent Project   
 <?php $__env->endSlot(); ?>
<?php echo $__env->make('talent.assessment-project-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php
$talent = Auth::user()->talent;
?>

<form class="" novalidate="novalidate" id="kt_add_project_form" action="<?php echo e(route('update.assproject')); ?>" method="POST" enctype="multipart/form-data">
<?php echo csrf_field(); ?>
<?php echo Form::hidden('talent_id', $talent->id); ?> 

<?php if($section==''||$section=='executive-summary'): ?> 
<?php echo Form::hidden('tab', 1); ?> 
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <!-- <div class="form-floating mb-7"> -->
                        <?php echo Form::textarea('exec_summary', $project->exec_summary??'', array('class'=>'form-control','id'=>'exec_summary','placeholder'=>'','rows'=>'10')); ?> 
...
<?php if($section=='presentation-publication'): ?> 
<?php echo Form::hidden('tab', 2); ?> 
<div class="card mb-5 mb-xxl-8">
    <div class="card-header border-0">
        <h3 class="card-title align-items-start flex-column">
    ...
    <div class="card-body pb-0">
        <div class="fv-row mb-8 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <?php echo Form::textarea('project_title', $project->project_title??'', array('class'=>'form-control','placeholder'=>'','rows'=>'2')); ?> 
            <!--end::Input-->
        </div>
        <div class="fv-row mb-8 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
            <!--begin::Label-->
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <?php echo Form::textarea('project_presentation', $project->project_presentation??'', array('class'=>'form-control','placeholder'=>'','rows'=>'5')); ?> 
            <!--end::Input-->
        </div>
        <div class="fv-row mb-8 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
            <!--begin::Label-->
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <?php echo Form::textarea('project_publication', $project->project_publication??'', array('class'=>'form-control','placeholder'=>'','rows'=>'5')); ?> 
            <!--end::Input-->
        </div>
    </div>
    <!--end::Body-->
...
<?php if($section=='project-report'): ?> 
<?php echo Form::hidden('tab', 3); ?> 
<div class="card mb-5 mb-xxl-8">
    <!-- <div class="card-header border-0">
        <h3 class="card-title align-items-start flex-column">
    ...
    <div class="card-body pb-0">
        <div class="row">
            ...
            <div class="col-3">
                <div class="fv-row mb-15">
                    <?php if(!is_null($project->file_report)): ?>
                    <div class="mb-3 text-center">
                        <a href="<?php echo e(url('project/'.$project->file_report)); ?>" target="_blank" class="text-gray-800 text-hover-primary d-flex flex-column">
                            <!--begin::Image-->
...
<?php if($section=='final-presentation'): ?> 
<?php echo Form::hidden('tab', 4); ?> 
<div class="card mb-5 mb-xxl-8">
    <!--begin::Body-->
    <div class="card-body pb-0">
        <div class="row">
...
However, the latest submission deadline is TWO WEEKS BEFORE the Assessment Panel Meeting. Failure to submit can lead to disqualification from the Assessment. Should major editions occur, the talent is encouraged to submit an updated Project Presentation.
            ...
            <div class="col-3">
                <div class="fv-row mb-15">
                    <?php if(!is_null($project->file_presentation)): ?>
                    <div class="mb-3 text-center">
                        <a href="<?php echo e(url('project/'.$project->file_presentation)); ?>" target="_blank" class="text-gray-800 text-hover-primary d-flex flex-column">
                            <!--begin::Image-->
                            <div class="symbol symbol-60px mb-5">
                                <img src="<?php echo e(url('')); ?>/assets/media/svg/files/pdf.svg" alt="">
                            </div>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/talent/assessment-project.blade.php ENDPATH**/ ?>
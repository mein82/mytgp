<div class="d-flex flex-wrap flex-stack p-5">
	<!--begin::Heading-->
	<h3 class="fw-bolder my-2">TGP Project <span class="fs-6 text-gray-400 fw-bold ms-1">Click on the title to see detailed progress</span></h3>
	<!--end::Heading-->
</div>
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
	<!--begin::Card body-->
	<div class="card-body p-9 table-responsive">
		<?php if($talent->project->count()==0): ?>
		No record
		<?php else: ?>
		<!--begin::Accordion-->
		<div class="accordion accordion-icon-toggle" id="kt_accordion_2">
			<?php $i = 0 ?>
			<?php $__currentLoopData = $talent->project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<?php $i++; ?>
		    <!--begin::Item-->
		    <div class="mb-5">
		        <!--begin::Header-->
		        <div class="accordion-header py-3 d-flex collapse collapsed" data-bs-toggle="collapse" data-bs-target="#kt_accordion_2_item_<?php echo e($i); ?>">
		            ...
		            <h4 class="fs-4 fw-bold mb-0 ms-4 text-gray-800 mb-1"><?php echo e($item->title); ?> <span class="badge badge-secondary ms-4"><?php echo e($item->progress->count()); ?> Progress</span></h4>
		            <div class="ms-4 m-1">Name of Co-Investigators &amp; their workplace: <span class="text-primary"><?php echo nl2br($item->coinvestigator); ?></span></div>
		            <div class="ms-4 m-1">NMRR ID:<span class="badge badge-light-danger mx-4"><?php echo e($item->nmrr_id); ?></span>Date of MREC approval:<span class="badge badge-light-success mx-4"><?php echo e($item->mrecapp_date); ?></span></div>
		        </div>
		        </div>
		        <!--end::Header-->

		        <!--begin::Body-->
		        <div id="kt_accordion_2_item_<?php echo e($i); ?>" class="fs-6 collapse ps-10" data-bs-parent="#kt_accordion_2">
		             	<table class="table table-rounded table-striped border table-row-bordered table-row-gray-200 gy-3 gx-5">
		             		<tbody>
		                <?php $x = 0; ?>        
		             	<?php $__currentLoopData = $item->progress; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                <?php $x++; ?>        
		             	<tr><td colspan="2" class="fw-bold fs-6"><?php echo e($x); ?>) <?php echo e(date("d-m-Y",strtotime($subitem->created_at))); ?></td></tr>
		                <tr>
...
</div><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/project-progress.blade.php ENDPATH**/ ?>
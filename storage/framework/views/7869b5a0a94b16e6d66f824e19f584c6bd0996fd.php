...
<div class="card">
	...
	<div class="card-body">
		...
		?>
		<?php echo Form::model($twer, array('route' => ['add.talenttwer'], 'method'=>'POST', 'id'=>'kt_new_target_form','files'=>'true')); ?>	 
		...
		<div class="fv-row mb-5">
			...
			<?php echo Form::text('title', null, array('class'=>'form-control maxlength-50','placeholder'=>'', $disabled)); ?> 
		...
		<div class="fv-row mb-5">
			<div class="row">
				<div class="col-6">
					...
					<div class="form-floating">
					<?php echo Form::textarea('background', null, array('class'=>'form-control maxlength-100','style'=>'height: 120px','placeholder'=>'',$disabled)); ?> 
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="form-floating">
					<?php echo Form::textarea('problem', null, array('class'=>'form-control maxlength-100','style'=>'height: 80px','placeholder'=>'',$disabled)); ?> 
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="form-floating">
					...
					<?php echo Form::textarea('situation', null, array('class'=>'form-control maxlength-100','style'=>'height: 170px','placeholder'=>'',$disabled)); ?> 
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="col-lg-6">
					<?php if($twer->situation_file!=""): ?>
					<a href="<?php echo e(url('twer').'/'.$twer->situation_file); ?>"  target="_blank" class="btn btn-primary btn-sm"><span class="svg-icon svg-icon-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
...
<?php if($edit): ?>
<a href="<?php echo e(url('remove/twerfile/situation_file').'/'.$twer->id); ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
...
<?php endif; ?>
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="form-floating">
					...
					<?php echo Form::textarea('target', null, array('class'=>'form-control maxlength-200','style'=>'height: 170px','placeholder'=>'',$disabled)); ?> 
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="col-lg-6">
					<?php if($twer->target_file!=""): ?>
					<a href="<?php echo e(url('twer').'/'.$twer->target_file); ?>"  target="_blank" class="btn btn-primary btn-sm"><span class="svg-icon svg-icon-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
</svg></span>Attachment</a>
<?php if($edit): ?>
<a href="<?php echo e(url('remove/twerfile/target_file').'/'.$twer->id); ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
					<!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
					<span class="svg-icon svg-icon-3">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							<path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="black"></path>
...
<?php endif; ?>
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="form-floating">
					...
					<?php echo Form::textarea('gap', null, array('class'=>'form-control maxlength-200','style'=>'height: 170px','placeholder'=>'',$disabled)); ?> 
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="col-lg-6">
					<?php if($twer->gap_file!=""): ?>
					<a href="<?php echo e(url('twer').'/'.$twer->gap_file); ?>"  target="_blank" class="btn btn-primary btn-sm"><span class="svg-icon svg-icon-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
</svg></span>Attachment</a>
<?php if($edit): ?>
<a href="<?php echo e(url('remove/twerfile/gap_file').'/'.$twer->id); ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
					<!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
					<span class="svg-icon svg-icon-3">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							<path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="black"></path>
...
<?php endif; ?>
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="form-floating">
					...
					<?php echo Form::textarea('stratergies', null, array('class'=>'form-control maxlength-200','style'=>'height: 170px','placeholder'=>'',$disabled)); ?>

					<label for="statement" class="required">Strategies Needed / Counter measures</label>
				</div>
				<?php if(count(array_filter($audit->pluck('old_values.stragtergies')->toArray()))>0): ?>
					<!--begin::Accordion-->
					<div class="accordion accordion-icon-toggle" id="kt_accordion_stragtergies">
					    ...
					    <div class="">
					        ...
					        <div id="kt_accordion_stragtergies_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_stragtergies">
					            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.stragtergies')->toArray())); ?>
		...
		<div class="fv-row mb-5">
			...
			<!-- <label class="required form-label">Action Plan : How Implement? (4 W's, 1 H)</label> -->
					<?php echo Form::textarea('plan', null, array('class'=>'form-control maxlength-200','style'=>'height: 170px','placeholder'=>'',$disabled)); ?> 
		...
		<div class="fv-row mb-5">
			<div class="row">
				<div class="col-lg-6">
					...
					<?php if($twer->plan_file!=""): ?>
					<a href="<?php echo e(url('twer').'/'.$twer->plan_file); ?>"  target="_blank" class="btn btn-primary btn-sm"><span class="svg-icon svg-icon-3"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
</svg></span>Attachment</a>
<?php if($edit): ?>
<a href="<?php echo e(url('remove/twerfile/plan_file').'/'.$twer->id); ?>" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm">
					<!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
					<span class="svg-icon svg-icon-3">
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							<path d="M5 9C5 8.44772 5.44772 8 6 8H18C18.5523 8 19 8.44772 19 9V18C19 19.6569 17.6569 21 16 21H8C6.34315 21 5 19.6569 5 18V9Z" fill="black"></path>
...
<?php endif; ?>
		...
		<div class="fv-row mb-5">
			...
			<!-- <label class="required form-label">Effect Confirmation</label> -->
					<?php echo Form::textarea('effect', null, array('class'=>'form-control maxlength-100','style'=>'height: 100px','placeholder'=>'',$disabled)); ?> 
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<!-- <label class="required form-label">Follow up. How will you ensure on-going PDCA?</label> -->
					<?php echo Form::textarea('followup', null, array('class'=>'form-control maxlength-100','style'=>'height: 100px','placeholder'=>'',$disabled)); ?>
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="form-floating">
				<!-- <label class="required form-label">Follow up. How will you ensure on-going PDCA?</label> -->
					<?php echo Form::textarea('spread', null, array('class'=>'form-control maxlength-100','style'=>'height: 80px','placeholder'=>'',$disabled)); ?>
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="form-floating">
				<!-- <label class="required form-label">Follow up. How will you ensure on-going PDCA?</label> -->
					<?php echo Form::textarea('well', null, array('class'=>'form-control maxlength-100','style'=>'height: 100px','placeholder'=>'',$disabled)); ?>
				...
				<div class="form-floating">
				<!-- <label class="required form-label">Follow up. How will you ensure on-going PDCA?</label> -->
					<?php echo Form::textarea('notwell', null, array('class'=>'form-control maxlength-100','style'=>'height: 100px','placeholder'=>'',$disabled)); ?>
		...
		<div class="fv-row mb-5">
			<div class="row">
				...
				<div class="form-floating">
				<!-- <label class="required form-label">Follow up. How will you ensure on-going PDCA?</label> -->
					<?php echo Form::textarea('helped', null, array('class'=>'form-control maxlength-100','style'=>'height: 100px','placeholder'=>'',$disabled)); ?>
				...
				<div class="form-floating">
				<!-- <label class="required form-label">Follow up. How will you ensure on-going PDCA?</label> -->
					<?php echo Form::textarea('hindered', null, array('class'=>'form-control maxlength-100','style'=>'height: 100px','placeholder'=>'',$disabled)); ?>
						...
						<div class="card-body fs-6 pe-3">
							...
							<div class="scroll mh-450px">
								...
								<tbody class="fw-bold fs-7">
									<?php $__currentLoopData = $twer->comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/talent/twer.blade.php ENDPATH**/ ?>
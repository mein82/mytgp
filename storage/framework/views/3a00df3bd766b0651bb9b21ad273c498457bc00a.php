...
<div class="card d-flex flex-row-fluid flex-center">
	<!--begin::Form-->
	<form class="card-body py-20 w-100 w-xl-800px px-1" novalidate="novalidate" id="kt_create_account_form" action="<?php echo e(route('create.applicant')); ?>" method="POST" enctype="multipart/form-data">
				<!--begin::Step 1-->
			...
			<div class="w-100">
				...
				<div class="fv-row mb-10">
						...
						<div class="row mb-6">
							<!--begin::Col-->
							<div class="col-lg-8">
								<div class="image-input image-input-outline image-input-empty" data-kt-image-input="true" style="background-image: url('<?php echo e(url("")); ?>/assets/media/svg/avatars/blank.svg')">
									...
									<label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="" data-bs-original-title="Change avatar">
										...
										<input type="hidden" name="avatar_file" value="<?php echo e(Auth::user()->avatar); ?>">
				...
				<div class="fv-row mb-10">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<!--begin::Input-->
							<?php echo Form::select('title_id',$title,null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Title...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
						<div class="col-lg-8">
							<!--begin::Input group-->
							<div class="form-floating">
							    <?php echo Form::text('name', Auth::user()->name, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
				...
				<div class="fv-row mb-10">	
					<div class="row">
						...
						<div class="col-lg-4">
							<!--begin::Input group-->
							<div class="form-floating">
							    <?php echo Form::text('ic_no', null, array('class'=>'form-control','id'=>'ic_no','placeholder'=>'')); ?> 
						...
						<div class="col-lg-4">
							<!--begin::Input group-->
							<div class="form-floating">
							    <?php echo Form::text('dob', null, array('class'=>'form-control','id'=>'dob','placeholder'=>'')); ?> 
						...
						<div class="col-lg-4">
							<!--begin::Input-->
							<?php echo Form::select('gender_id',[''=>'','1' => 'MALE', '2' => 'FEMALE'],null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Gender...','data-hide-search'=>'true','data-control'=>'select2','id'=>'gender_id')); ?> 
						</div>
					</div>
				</div>
				<div class="fv-row mb-10"><!--end::Input-->
					<div class="row">
						<!--begin::Col-->
						<div class="col-lg-4">
							 <?php echo Form::select('marital_id', $marital, null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Marital status...','data-hide-search'=>'true','data-control'=>'select2') ); ?> 

						
						</div>
						<div class="col-lg-4">
							 <?php echo Form::select('ethnic_id', $ethnic, null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Ethnic...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
				...
				<div class="fv-row mb-10">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<!--begin::Input-->
							 <div class="form-floating">
							 	<?php echo Form::text('position', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
						...
						<div class="col-lg-6">
							<!--begin::Input group-->
							<div class="form-floating">
							    <?php echo Form::text('designation', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
				...
				<div class="fv-row mb-10">
					...
					<div class="row">
						<!--begin::Col-->
						<div class="col-lg-3">
							 <?php echo Form::select('scheme_id', $schemes, null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Schemes...','data-hide-search'=>'true','data-control'=>'select2') ); ?> 
						</div>
						<div class="col-lg-3">
							 <?php echo Form::select('grade_id', $grades, null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Grade...','data-hide-search'=>'true','data-control'=>'select2') ); ?> 
						</div>
						<div class="col-lg-6">
							 <?php echo Form::select('programme_id', $programme, null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Programme...','data-hide-search'=>'true','data-control'=>'select2') ); ?> 
						</div>
					</div>
				</div>
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-lg-12">
							<div class="form-floating">
								<?php echo Form::text('organization', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-lg-12">
							<div class="form-floating">
								<?php echo Form::text('office_street', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<div class="col-lg-4">
							<!--begin::Input group-->
							<div class="form-floating">
							    <?php echo Form::text('office_city', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
						...
						<div class="col-lg-4">
							<!--begin::Input group-->
							<div class="form-floating">
							    <?php echo Form::text('office_postcode', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'','id'=>'dob')); ?> 
						...
						<div class="col-lg-4">
							<!--begin::Input-->
							<?php echo Form::select('office_state', $state, null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'State...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
					</div>
				</div>
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-lg-12">
							<div class="form-floating">
								<?php echo Form::text('home_street', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
								 <label for="floatingInput">Street</label>
							</div>
						</div>
					</div>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<div class="col-lg-4">
							<!--begin::Input group-->
							<div class="form-floating">
							    <?php echo Form::text('home_city', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
							    <label for="floatingInput">City</label>
							</div>
							<!--end::Input group-->
						</div>
						<div class="col-lg-4">
							<!--begin::Input group-->
							<div class="form-floating">
							    <?php echo Form::text('home_postcode', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'','id'=>'dob')); ?> 
							    <label for="floatingInput">Postcode</label>
							</div>
							<!--end::Input group-->
						</div>
						<div class="col-lg-4">
							<!--begin::Input-->
							<?php echo Form::select('home_state', $state, null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'State...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
					</div>
				</div>
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-lg-4">
							<div class="form-floating">
								<?php echo Form::text('office_phone', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
								 <label for="floatingInput">Office</label>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-floating">
								<?php echo Form::text('mobile_phone', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
								 <label for="floatingInput">Mobile</label>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-floating">
								<?php echo Form::text('home_phone', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-lg-4">
							<div class="form-floating">
								<?php echo Form::text('official_email', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
								 <label for="floatingInput">Official</label>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-floating">
								<?php echo Form::text('personal_email', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-lg-4">
							<div class="form-floating">
								<?php echo Form::text('facebook', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
								 <label for="floatingInput">Facebook</label>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-floating">
								<?php echo Form::text('twitter', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
								 <label for="floatingInput">Twitter</label>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="form-floating">
								<?php echo Form::text('other_social', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
			...
			<div class="w-100">
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-lg-6">
							<div class="form-floating mb-7">
								<?php echo Form::text('specialization', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
								 <label for="floatingInput">Specialisation (If any)</label>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="form-floating mb-7">
								<?php echo Form::text('date_of_gazettement', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'','id'=>'date_of_gazettement')); ?> 
								 <label for="floatingInput">Date of Gazettement (If any)</label>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="form-floating mb-7">
								<?php echo Form::text('nsr_no', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
					...
					<div class="row">
						<div class="col-lg-6">
							<div class="form-floating mb-7">
								<?php echo Form::text('subspecialization', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
		...
		<div data-kt-stepper-element="content">
			...
			<div class="w-100">
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<!--begin::Input-->
								...
								<option value="" <?php if(optional($talent)->year_of_appt==null): ?> selected="" <?php endif; ?>></option>
								<?php for($i=date("Y");$i>date("Y")-65; $i--): ?>
								<option value="<?php echo e($i); ?>" <?php if(optional($talent)->year_of_appt==$i): ?> selected="" <?php endif; ?>><?php echo e($i); ?></option>
								<?php endfor; ?>
							</select>
						...
						<div class="col-lg-6">
							<!--begin::Input group-->
								...
								<select name="year_of_conf" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Year..">
									<option value="" <?php if(optional($talent)->year_of_conf==null): ?> selected="" <?php endif; ?>></option>
									<?php for($i=date("Y");$i>date("Y")-65; $i--): ?>
									<option value="<?php echo e($i); ?>" <?php if(optional($talent)->year_of_conf==$i): ?> selected="" <?php endif; ?>><?php echo e($i); ?></option>
									<?php endfor; ?>
								</select>
							<!--end::Input group-->
						</div>
				...
				<div class="mb-5 fv-row">
					...
					<div class="row mb-2">
						...
						<?php echo Form::select('managerial_id',$managerial,null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Choose...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
						<div class="col-lg-3 managerial d-none">
							 <select name="managerial_year" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Year..">
								<option value="" <?php if(optional($talent)->managerial_year==null): ?> selected="" <?php endif; ?>></option>
								<?php for($i=date("Y");$i>date("Y")-65; $i--): ?>
								<option value="<?php echo e($i); ?>" <?php if(optional($talent)->managerial_year==$i): ?> selected="" <?php endif; ?>><?php echo e($i); ?></option>
								<?php endfor; ?>
							</select>
						...
						<div class="col-lg-5 managerial d-none">
							<div class="form-floating">
								<?php echo Form::text('managerial_remark', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
				...
				<div class="mb-10 fv-row">
					...
					<div class="row mb-2">
						<div class="col-lg-4">
							<?php echo Form::select('committee_pos_id',$position,null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Choose...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
						<div class="col-lg-3 committee d-none">
							  <select name="committee_year" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Year..">
								<option value="" <?php if(optional($talent)->committee_year==null): ?> selected="" <?php endif; ?>></option>
								<?php for($i=date("Y");$i>date("Y")-65; $i--): ?>
								<option value="<?php echo e($i); ?>" <?php if(optional($talent)->committee_year==$i): ?> selected="" <?php endif; ?>><?php echo e($i); ?></option>
								<?php endfor; ?>
							</select>
						</div>
						<div class="col-lg-5 committee d-none">
							<div class="form-floating">
							<?php echo Form::text('committee_remark', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
				...
				<div class="row mb-2">
					<div class="col-lg-4">
						...
						<?php echo Form::select('programme_pos_id',$position,null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Choose...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
					</div>
					<div class="col-lg-3 programme d-none">
						<select name="programme_year" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Year..">
								<option value="" <?php if(optional($talent)->programme_year==null): ?> selected="" <?php endif; ?>></option>
								<?php for($i=date("Y");$i>date("Y")-65; $i--): ?>
								<option value="<?php echo e($i); ?>" <?php if(optional($talent)->programme_year==$i): ?> selected="" <?php endif; ?>><?php echo e($i); ?></option>
								<?php endfor; ?>
							</select>
					</div>
					<div class="col-lg-5 programme d-none">
						<div class="form-floating">
						<?php echo Form::text('programme_remark', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
			...
			<div class="mb-10 fv-row">
				...
				<div class="row mb-2">
					<div class="col-lg-3">
						<?php echo Form::select('voluntary_id',['1' => 'YES', '0' =>'NO'], null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Choose...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
					</div>
					<div class="col-lg-3 voluntary d-none">
						 <select name="voluntary_year" class="form-select form-select-lg form-select-solid" data-control="select2" data-placeholder="Year..">
								<option value="" <?php if(optional($talent)->voluntary_year==null): ?> selected="" <?php endif; ?>></option>
								<?php for($i=date("Y");$i>date("Y")-65; $i--): ?>
								<option value="<?php echo e($i); ?>" <?php if(optional($talent)->voluntary_year==$i): ?> selected="" <?php endif; ?>><?php echo e($i); ?></option>
								<?php endfor; ?>
							</select>
					</div>
					<div class="col-lg-3 voluntary d-none">
						<div class="form-floating">
						<?php echo Form::text('voluntary_org', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
						<label for="floatingInput">State the organisation</label>
						</div>
					</div>
					<div class="col-lg-3 voluntary d-none">
						<?php echo Form::select('voluntary_pos_id',$social,null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Choose Position..','data-hide-search'=>'true','data-control'=>'select2')); ?> 
					</div>
				</div>
			</div>
			...
			<div class="mb-10 fv-row">
				...
				<div class="row mb-5">
					<div class="col-lg-2">
						...
						<?php echo Form::select('research_id',[ ''=>'', '1' => 'YES', '0' =>'NO'], null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Choose...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
					</div>
				</div>
				<div class="row mb-10">
					<div class="col-lg-4 research d-none">
						<div class="form-floating">
						    <?php echo Form::select('research_role',[ ''=>'', '1' => 'Co-Investigator', '2' =>'Primary Investigator'], null, array('class'=>'form-select form-select-lg form-select-solid fs-6 pt-5','data-placeholder'=>'Choose...','data-hide-search'=>'true','data-control'=>'select2', 'id'=>'floatingSelect')); ?> 
						    <label for="floatingSelect">What is your role?</label>
						</div>
					</div>
					<div class="col-lg-5 research d-none">
						<div class="form-floating">
						<?php echo Form::text('research_title', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
						<label for="floatingInput">Please state the title</label>
						</div>
					</div>
					<div class="col-lg-3 research d-none">
						<div class="form-floating">
						<?php echo Form::text('research_nmrrid', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
					...
					<label class="form-label">Did you present your research findings at any conference/seminar?</label>
						...
						<div class="col-lg-2">
							<?php echo Form::select('present_id',[''=>'','1' => 'YES', '0' =>'NO'], null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Choose...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
						<div class="col-lg-7 present d-none">
							<div class="form-floating">
							<?php echo Form::text('present_remark', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
					...
					<div class="row mb-5 research present d-none">	
						<div class="col-lg-2 present d-none">
							<?php echo Form::select('present_type',[ ''=>'', 'Oral' => 'Oral', 'Poster' =>'Poster','Others'=>'Others'], null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Presentation Type...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
						<div class="col-lg-5 present d-none">
							<div class="form-floating">
							<?php echo Form::text('present_title', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
							<label for="floatingInput">Please state the title</label>
							</div>
						</div>
						<div class="col-lg-5 present d-none">
							<div class="form-floating">
							<?php echo Form::text('present_venue', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
					...
					<label class="form-label">Did you publish your research findings at any journal or as a technical report?</label>
						...
						<div class="col-lg-2">
							<?php echo Form::select('publish_id',[''=>'','1' => 'YES', '0' =>'NO'], null, array('class'=>'form-select form-select-lg form-select-solid','data-placeholder'=>'Choose...','data-hide-search'=>'true','data-control'=>'select2')); ?> 
						</div>
					</div>
					<div class="row mb-10 research d-none">	
						<div class="col-lg-5 publish d-none">
							<div class="form-floating">
							<?php echo Form::text('publish_remark', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
							<label for="floatingInput">If YES, please state the journal or the technical report</label>
							</div>
						</div>
						<div class="col-lg-5 publish d-none">
							<div class="form-floating">
							<?php echo Form::text('publish_title', null, array('class'=>'form-control','id'=>'floatingInput','placeholder'=>'')); ?> 
							<label for="floatingInput">Please state the title</label>
							</div>
						</div>
				...
				<div class="fv-row mb-15">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<!--begin::Input group-->
							<!-- <div class="form-floating mb-7"> -->
							    <?php echo Form::textarea('statement', null, array('class'=>'form-control','id'=>'statement','placeholder'=>'','rows'=>'3')); ?> 
...
<?php endif; ?><?php /**PATH /var/www/html/mytgp/resources/views/applicant/e-form.blade.php ENDPATH**/ ?>
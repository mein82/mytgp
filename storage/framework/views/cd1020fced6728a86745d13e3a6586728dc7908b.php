    ...
    <tbody class="text-gray-800">
        ...
        <?php $count = 0; ?>
            <tr>
				...
				<td>
					<span class="badge badge-<?php echo e(!is_null($item->talent->superlog2)?'success':'warning'); ?>">1st Year</span><br/>
					<span class="badge badge-<?php echo e(!is_null($item->talent->superlog3)?'success':'warning'); ?>">2nd Year</span>
				</td>
				<td>
					<span class="badge badge-<?php echo e(!is_null($item->talent->twer1)&&!is_null($item->talent->twer1->mark)?'success':'warning'); ?>">1st Year</span><br/>
					<span class="badge badge-<?php echo e(!is_null($item->talent->twer2)&&!is_null($item->talent->twer2->mark)?'success':'warning'); ?>">2nd Year</span>
				</td>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/supervisor/talents.blade.php ENDPATH**/ ?>
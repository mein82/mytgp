...
<?php echo Form::model($user, array('route' => ['update.user', $user->id], 'method'=>'PATCH', 'id' => 'kt_add_course_form')); ?>
...
<div class="card card-flush pt-3 mb-5 mb-lg-10">
	...
	<div class="card-body pt-0">
		...
		<div class="row g-9 mb-7">
			...
			<div class="col-md-2 fv-row <?php if($user->group_id!=5): ?> d-none <?php endif; ?> programme">
				<!--begin::Label-->
				<label class="fs-6 fw-bold mb-2">
			...
			<label class="fs-6 fw-bold mb-2">
				...
				<div class="form-check form-check-custom form-check-solid">
					<input class="form-check-input" type="checkbox" name="email_verified" value="1" id="flexCheckDefault" <?php if(!is_null($user->email_verified_at)): ?> checked="checked" <?php endif; ?>/>
					<label class="form-check-label" for="flexCheckDefault">
						Yes
					</label>
				</div>
			</div>
			<div class="col-md-3 fv-row <?php if($user->group_id!=5): ?> d-none <?php endif; ?> main-panel">
				<label class="fs-6 fw-bold mb-2">Main Panel?</label>
				<div class="form-check form-check-custom form-check-solid form-check-lg">
				    <input class="form-check-input h-40px w-40px" type="checkbox" <?php if($user->main==1): ?> checked="" <?php endif; ?> name="main" value="1" id="flexCheckDefault"/>
				    <label class="form-check-label" for="flexCheckDefault">
				        Yes
				    </label>
				</div>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/user-edit.blade.php ENDPATH**/ ?>
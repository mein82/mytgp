...
<?php $component = $__env->getContainer()->make(App\View\Components\AppLayout::class, ['activemenu' => 'sec-app-selection']); ?>
...
<table id="kt_datatable_example_2" class="table align-middle table-row-dashed fs-6 gy-5">
    ...
    <tbody class="text-gray-600 fw-bold">
        ...
        <tr>
            ...
            <td><?php echo e($item->applicant->status->status->name??''); ?></td>
            <td><?php echo e($item->applicant->status->status_id??''); ?></td>
            <td><a href="#" class="btn btn-light btn-active-light-primary btn-sm" data-id="<?php echo e($item->applicant->id); ?>" data-bs-toggle="modal" data-bs-target="#kt_modal_app_selection">Convert</a></td>
        </tr>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
</table>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/applicant-selections.blade.php ENDPATH**/ ?>
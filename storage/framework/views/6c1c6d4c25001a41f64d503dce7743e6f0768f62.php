...
<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed">
    ...
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
        ...
        <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
            <!--begin::Form-->
            <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" action="<?php echo e(route('register')); ?>" method="POST">
             <?php echo csrf_field(); ?>    <!--begin::Heading-->
                <div class="mb-10 text-center">
                    ...
                    <a href="<?php echo e(url('login')); ?>">Sign in here</a></div>
                    <!--end::Link-->
                </div>
                <!--end::Heading-->
...
<?php endif; ?>                            <!--begin::Input group-->
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Col-->
                                    ...
                                    <?php echo $errors->first('g-recaptcha-response','<div class="fv-plugins-message-container invalid-feedback"><div data-field="g-recaptcha-response" data-validator="notEmpty">:message</div></div>'); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/mytgp/resources/views/auth/register.blade.php ENDPATH**/ ?>
        ...
        <?php $count = 0; ?>
            <tr>
                ...
                <td class="text-center">
                	<button type="button" class="btn btn-success <?php if($item->talent->status->course_complete): ?> btn-warning <?php endif; ?>	 btn-icon btn-sm position-relative me-5" data-bs-toggle="modal" data-id="<?php echo e($item->id); ?>" data-bs-target="#kt_modal_courses"><?php echo e($item->talent->course->where('status_id',4)->count()??''); ?></button>

                </td>
                <td class="text-center">
					<button type="button" class="btn btn-danger btn-icon btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_project" data-id="<?php echo e($item->id); ?>"><?php echo e($item->talent->project->count()); ?></button>
                </td>
                ...
                <td class="text-end">
                    <a href="<?php echo e(url('/panel/talent/summary/'.$item->id)); ?>" class="btn btn-dark btn-active-light-primary btn-sm">Evaluate</a>
                </td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
...
<?php endif; ?><?php /**PATH /var/www/html/mytgp/resources/views/panel/talents.blade.php ENDPATH**/ ?>
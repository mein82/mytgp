...
<?php echo Form::open(array('route' => ['add.course'], 'method'=>'POST', 'id' => 'kt_add_course_form')); ?>
...
<div class="card card-flush pt-3 mb-5 mb-lg-10">
	...
	<div class="card-body pt-0">
		...
		<div class="row g-9 mb-7">
			...
			<!--end::Col-->
			<!--begin::Col-->
			<div class="col-md-4 fv-row domain d-none">
				<!--begin::Label-->
				<label class="fs-6 fw-bold mb-2">
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/training-form.blade.php ENDPATH**/ ?>
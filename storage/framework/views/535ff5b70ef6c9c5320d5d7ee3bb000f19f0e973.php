			...
			<div class="card-header">
				...
				<div class="card-toolbar">
					...
					<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de0f5f83814">
						...
						<!--end::Menu separator-->
						<?php echo Form::open(array('route' => ['delete.talentlogbook'], 'method'=>'POST', 'id' => 'kt_add_mark_form')); ?>
			...
			<div class="card-header">
				...
				<div class="card-toolbar">
					...
					<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de0f5f83814">
						...
						<div class="separator border-gray-200"></div>
						<!--end::Menu separator-->
						<?php echo Form::open(array('route' => ['delete.supervisorlogbook'], 'method'=>'POST', 'id' => 'kt_add_mark_form')); ?>
...
KTUtil.onDOMContentLoaded((function() {
 ...
 <?php $__env->endSlot(); ?>
<?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/logbook-chart.blade.php ENDPATH**/ ?>
...
<?php echo Form::open(array('route' => ['add.project'], 'method'=>'POST', 'id' => 'kt_add_course_form')); ?>
...
<div class="card card-flush pt-3 mb-5 mb-lg-10">
	...
	<div class="card-body pt-0">
		...
		<div class="row g-9 mb-7">
			...
			<!--end::Col-->
			<!--begin::Col-->
			<div class="col-md-3 fv-row research d-none">
				<!--begin::Label-->
			...
			<!--end::Col-->
			<!--begin::Col-->
			<div class="col-md-2 fv-row research d-none">
				<!--begin::Label-->
...
<?php endif; ?><?php /**PATH /var/www/html/mytgp/resources/views/talent/project-form.blade.php ENDPATH**/ ?>
                    ...
                    <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="<?php echo e(route('login')); ?>" method="POST">
                            ...
                            <div class="text-center mb-10">
                                ...
                                <a href="<?php echo e(url('register')); ?>">Create an Account</a></div>
                                <!--end::Link-->
                            </div>
                            <!--begin::Heading-->
...
<?php endif; ?>
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <div class="d-flex flex-stack mb-2">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Link-->
                                    <a href="<?php echo e(url('forgot-password')); ?>" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Input-->
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/auth/login.blade.php ENDPATH**/ ?>
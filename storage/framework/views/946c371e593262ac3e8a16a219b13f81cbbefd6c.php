...
<?php $component = $__env->getContainer()->make(App\View\Components\AppLayout::class, ['activemenu' => 'sec-supervisor']); ?>
    ...
    <tbody class="text-gray-800">
        ...
        <?php $count = 0; ?>
            <tr>
                ...
                <td><?php echo e($item->programme->name??''); ?></td>
                <td>
				<table class="table table-row-dashed table-row-gray-500 align-middle gx-1 gy-1">
					<?php $__currentLoopData = $item->supervisor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							<td class="w-50">
								<?php echo e($sup->talent->fullname); ?><br/>
								<span class="text-gray-700 fs-7">Cohort <?php echo e($sup->talent->status->cohort??''); ?></span>
							</td>
							<td class="fs-7 flex flex-row">
								<?php if(is_null($sup->talent->superlog2)): ?>
								<div>	TGP-CM 1st Year</div>
								<?php endif; ?>
								<?php if(is_null($sup->talent->superlog3)): ?>
								<div>	TGP-CM 2nd Year</div>
								<?php endif; ?>
								<?php if(!is_null($sup->talent->twer1) && is_null($sup->talent->twer1->mark)): ?>
								<div>	TWER 1st Year</div>
								<?php endif; ?>
								<?php if(!is_null($sup->talent->twer2) && is_null($sup->talent->twer2->mark)): ?>
                ...
                <td class="text-end">
                    <a href="<?php echo e(url('')); ?>/impersonate/user/<?php echo e($item->id); ?>/secretariat-supervisors" id="<?php echo e($item->id); ?>" class="btn btn-secondary btn-active-light-primary btn-sm" data-kt-user-table-filter="log_row">Impersonate</a>
                </td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/supervisors.blade.php ENDPATH**/ ?>
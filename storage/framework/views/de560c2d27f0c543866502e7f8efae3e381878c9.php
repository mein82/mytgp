...
<div class="d-flex flex-wrap flex-stack pt-10 pb-8">
	...
	<div class="d-flex flex-wrap my-1">
		...
		<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true">
			...
			<!--end::Menu separator-->
			<?php echo Form::open(array('route' => ['reset.talenttwer'], 'method'=>'GET')); ?>
...
<div class="tab-content">
	...
	<div class="card-body fs-6 text-gray-700">
		...
		<div class="d-flex flex-column flex-xl-row">
			...
			<div class="flex-lg-row-fluid me-lg-10">
				<div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
					<div class="fv-row mb-10">
						...
						<div class="text-primary mt-3">
							<?php echo e($talent->twer1->title??''); ?>

						</div>
						<?php if(count(array_filter($audit->pluck('old_values.title')->toArray()))>0): ?>
						<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_title">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_title_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_title">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.title')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-6">
							...
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->background??''); ?>

							</div>
							<?php if(count(array_filter($audit->pluck('old_values.background')->toArray()))>0): ?>
							<!--begin::Accordion-->
							<div class="accordion accordion-icon-toggle" id="kt_accordion_background">
							    ...
							    <div class="">
							        ...
							        <div id="kt_accordion_background_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_background">
							            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.background')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-6">
							...
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->problem??''); ?>

							</div>
							<?php if(count(array_filter($audit->pluck('old_values.problem')->toArray()))>0): ?>
							<!--begin::Accordion-->
							<div class="accordion accordion-icon-toggle" id="kt_accordion_problem">
							    ...
							    <div class="">
							        ...
							        <div id="kt_accordion_problem_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_problem">
							            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.problem')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Current Situation : Where do things stand now?</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->situation??''); ?>

								<?php if($talent->twer1 && $talent->twer1->situation_file!=""): ?>
								<br/><a href="<?php echo e(url('twer').'/'.$talent->twer1->situation_file); ?>"  target="_blank" class="btn btn-light-primary btn-sm mt-3"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							...
							<?php if(count(array_filter($audit->pluck('old_values.situation')->toArray()))>0): ?>
							<!--begin::Accordion-->
							<div class="accordion accordion-icon-toggle" id="kt_accordion_situation">
							    ...
							    <div class="mb-5">
							        ...
							        <div id="kt_accordion_situation_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_situation">
							            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.situation')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Target State : What specific outcome is required?</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->target??''); ?>

								<?php if($talent->twer1 && $talent->twer1->target_file!=""): ?>
								<br/><a href="<?php echo e(url('twer').'/'.$talent->twer1->target_file); ?>"  target="_blank" class="btn btn-light-primary btn-sm mt-3"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
								<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
								<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
								</svg></span>Attachment</a>
						...
						<?php if(count(array_filter($audit->pluck('old_values.target')->toArray()))>0): ?>
					<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_target">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_target_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_target">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.target')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Gap Analysis : Why does the problem exist?</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->gap??''); ?>

								<?php if($talent->twer1 && $talent->twer1->gap_file!=""): ?>
								<br/><a href="<?php echo e(url('twer').'/'.$talent->twer1->gap_file); ?>"  target="_blank" class="btn btn-light-primary btn-sm mt-3"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
								<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
								<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
								</svg></span>Attachment</a>
							...
							<?php if(count(array_filter($audit->pluck('old_values.gap')->toArray()))>0): ?>
						<!--begin::Accordion-->
							<div class="accordion accordion-icon-toggle" id="kt_accordion_gap">
							    ...
							    <div class="">
							        ...
							        <div id="kt_accordion_gap_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_gap">
							            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.gap')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Strategies Needed / Counter measures</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->stratergies??''); ?>

							</div>
							<?php if(count(array_filter($audit->pluck('old_values.stratergies')->toArray()))>0): ?>
							<!--begin::Accordion-->
							<div class="accordion accordion-icon-toggle" id="kt_accordion_stratergies">
							    ...
							    <div class="">
							        ...
							        <div id="kt_accordion_stratergies_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_stratergies">
							            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.stratergies')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Action Plan : How to implement? (What, Who, Why, Where & How)</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->plan??''); ?>

								<?php if($talent->twer1 && $talent->twer1->plan_file!=""): ?>
								<br/><a href="<?php echo e(url('twer').'/'.$talent->twer1->plan_file); ?>"  target="_blank" class="btn btn-light-primary btn-sm mt-3"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
								<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
								<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
								</svg></span>Attachment</a>
							...
							<?php if(count(array_filter($audit->pluck('old_values.plan')->toArray()))>0): ?>
							<!--begin::Accordion-->
							<div class="accordion accordion-icon-toggle" id="kt_accordion_plan">
							    ...
							    <div class="">
							        ...
							        <div id="kt_accordion_plan_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_plan">
							            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.plan')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					...
					<label class="required form-label">Effect Confirmation</label>
						<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->effect??''); ?>

							</div>
						</div>
						<?php if(count(array_filter($audit->pluck('old_values.effect')->toArray()))>0): ?>
						<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_effect">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_effect_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_effect">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.effect')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer1->followup??''); ?>

						</div>
						<?php if(count(array_filter($audit->pluck('old_values.followup')->toArray()))>0): ?>
						<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_followup">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_followup_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_followup">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.followup')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer1->spread??''); ?>

						</div>
						<?php if(count(array_filter($audit->pluck('old_values.spread')->toArray()))>0): ?>
						<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_spread">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_spread_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_spread">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.spread')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer1->well??''); ?>

						</div>
						<?php if(count(array_filter($audit->pluck('old_values.well')->toArray()))>0): ?>
						<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_well">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_well_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_well">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.well')->toArray())); ?>
						...
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer1->notwell??''); ?>

						</div>
						<?php if(count(array_filter($audit->pluck('old_values.notwell')->toArray()))>0): ?>
						<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_notwell">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_notwell_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_notwell">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.notwell')->toArray())); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer1->helped??''); ?>

						</div>
						<?php if(count(array_filter($audit->pluck('old_values.helped')->toArray()))>0): ?>
						<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_helped">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_helped_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_helped">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.helped')->toArray())); ?>
						...
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer1->hindered??''); ?>

						</div>
						<?php if(count(array_filter($audit->pluck('old_values.hindered')->toArray()))>0): ?>
						<!--begin::Accordion-->
						<div class="accordion accordion-icon-toggle" id="kt_accordion_hindered">
						    ...
						    <div class="">
						        ...
						        <div id="kt_accordion_hindered_item" class="collapse fs-7 ps-10" data-bs-parent="#kt_accordion_hindered">
						            <?php echo implode('<div class="separator my-2"></div>',array_filter($audit->pluck('old_values.hindered')->toArray())); ?>
			...
			<?php echo Form::model($talent->twer1??'null', array('route' => ['mark.twer'], 'method'=>'POST', 'id' => 'kt_add_mark_form')); ?>

    		<input type="hidden" name="id" value="<?php echo e($talent->twer1->id??'null'); ?>">
				...
				<div class="d-flex flex-column rounded-3 p-7 border border-dashed border-gray-400 bg-light-warning">
					...
					<!-- <div class="separator separator-dashed mb-7"></div> -->
						...
						<!-- <div class="form-floating">
						    <input type="text" class="form-control"  name="mark" id="floatingInput" value="<?php echo e($talent->twer1->mark??''); ?>" />
						    <label for="floatingInput">Mark</label>
						</div> -->
						<?php if(!is_null($talent->twer1->mark??null)): ?>
						<div class="form-floating" style="height:100px;top:-100px;z-index:1;margin-bottom:-100px"></div>
						<?php endif; ?>
						<div class="d-flex justify-content-end">
					<!--begin::Button-->
					<button type="submit" id="kt_add_mark_submit" class="btn btn-sm  <?php if(!$talent->twer1 || !is_null($talent->twer1->mark)): ?> btn-secondary disabled <?php else: ?> btn-primary <?php endif; ?>">
						<span class="indicator-label"><?php if(!is_null($talent->twer1->mark??null)): ?> Submitted <?php else: ?> Submit <?php endif; ?></span>
	...
	<div class="flex-column flex-lg-row-auto w-100 w-350px mb-10">
		...
		<div class="card card-flush bg-light-success mb-0 table-responsive">
			<!--begin::Card body-->
			<?php if(Auth::user()->group_id==6 || Auth::user()->supervisor->count()>0): ?>
			<?php echo Form::model($talent->twer1??'null', array('route' => ['assesst.twer'], 'method'=>'POST', 'id' => 'kt_add_twer_form')); ?>
			...
			<div class="card-body fs-6 pe-3">
				<div class="scroll" id="twerContent">
						...
						<tr>
							...
							<td>
								...
								<label class="form-check form-check-sm form-check-custom justify-content-end">
									<input class="form-check-input"  type="checkbox" value="<?php echo e($cat->id); ?>" <?php if(in_array($cat->id,explode(",",$talent->twer1->checklist??''))): ?> checked <?php endif; ?> name="checklist[]">
								</label>
								<!--end::Checkbox-->
							</td>
						</tr>
					...
					<div class="d-flex justify-content-end">
						<!--begin::Button-->
						<button type="submit" id="kt_add_twer_submit" class="btn btn-sm btn-primary <?php if(!$talent->twer1): ?> disabled <?php endif; ?>">
					...
					<div class="fv-row">
					     ...
					     <?php if($talent->twer1 && $talent->twer1->comment->count()>0): ?>
						<table class="table align-middle table-rounded table-row-dashed table-row-gray-500 g-3">
						<tbody class="fw-bold fs-7">
							<?php $__currentLoopData = $talent->twer1->comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td>
									<?php echo e($c->comment); ?><br/>
									<span class="text-muted fs-8"><?php echo e($c->created_at); ?></span>
								</td>
							</tr>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
			...
			<div class="card-body fs-6 pe-3">
				<div class="scroll" id="twerContent">
				<h3 class="f-6 mb-5">Mark <span class="badge badge-primary fw-bolder p-3 ms-3 fs-6"><?php echo e($talent->twer1->mark??''); ?></span></h3>
				...
				<tbody class="fw-bold fs-7">
					...
					<tr>
						...
						<td>
							<!--begin::Checkbox-->
							<label class="form-check form-check-sm form-check-custom justify-content-end">
								<input class="form-check-input" disabled type="checkbox" value="<?php echo e($cat->id); ?>" <?php if(in_array($cat->id,explode(",",$talent->twer1->checklist??''))): ?> checked <?php endif; ?> name="checklist[]">
							</label>
							<!--end::Checkbox-->
						</td>
					</tr>
				...
				<div class="mb-10">
					<div class="form-check form-check-custom form-check-solid">
						<input class="form-check-input opentwer" name="open_id" type="checkbox"  <?php if($talent->twer1 && $talent->twer1->open_id): ?> checked="checked" <?php endif; ?> value="1" id="opentwer1">
	...
	<div class="card-body fs-6 text-gray-700">
		...
		<div class="d-flex flex-column flex-xl-row">
			...
			<div class="flex-lg-row-fluid me-lg-10">
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-6">
							<label class="required form-label">Background</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->background??''); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						<div class="col-6">
							<label class="required form-label">Problem Statement and Effect of the problem</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->problem??''); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Current Situation : Where do things stand now?</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->situation??''); ?>

								<?php if($talent->twer2 && $talent->twer2->situation_file!=""): ?>
								<br/><a href="<?php echo e(url('twer').'/'.$talent->twer2->situation_file); ?>"  target="_blank" class="btn btn-light-primary btn-sm mt-3"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
								<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
								<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
								</svg></span>Attachment</a>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Target State : What specific outcome is required?</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->target??''); ?>

								<?php if($talent->twer2 && $talent->twer2->target_file!=""): ?>
								<br/><a href="<?php echo e(url('twer').'/'.$talent->twer2->target_file); ?>"  target="_blank" class="btn btn-light-primary btn-sm mt-3"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
								<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
								<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
								</svg></span>Attachment</a>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Gap Analysis : Why does the problem exist?</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->gap??''); ?>

								<?php if($talent->twer2 && $talent->twer2->gap_file!=""): ?>
								<br/><a href="<?php echo e(url('twer').'/'.$talent->twer2->gap_file); ?>"  target="_blank" class="btn btn-light-primary btn-sm mt-3"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
								<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
								<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
								</svg></span>Attachment</a>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Strategies Needed / Counter measures</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->stratergies??''); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Action Plan : How to implement? (What, Who, Why, Where & How)</label>
							<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->plan??''); ?>

								<?php if($talent->twer2 && $talent->twer2->plan_file!=""): ?>
								<br/><a href="<?php echo e(url('twer').'/'.$talent->twer2->plan_file); ?>"  target="_blank" class="btn btn-light-primary btn-sm mt-3"><span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
								<rect opacity="0.3" width="12" height="2" rx="1" transform="matrix(0 -1 -1 0 12.75 19.75)" fill="black"/>
								<path d="M12.0573 17.8813L13.5203 16.1256C13.9121 15.6554 14.6232 15.6232 15.056 16.056C15.4457 16.4457 15.4641 17.0716 15.0979 17.4836L12.4974 20.4092C12.0996 20.8567 11.4004 20.8567 11.0026 20.4092L8.40206 17.4836C8.0359 17.0716 8.0543 16.4457 8.44401 16.056C8.87683 15.6232 9.58785 15.6554 9.9797 16.1256L11.4427 17.8813C11.6026 18.0732 11.8974 18.0732 12.0573 17.8813Z" fill="black"/>
								<path d="M18.75 15.75H17.75C17.1977 15.75 16.75 15.3023 16.75 14.75C16.75 14.1977 17.1977 13.75 17.75 13.75C18.3023 13.75 18.75 13.3023 18.75 12.75V5.75C18.75 5.19771 18.3023 4.75 17.75 4.75L5.75 4.75C5.19772 4.75 4.75 5.19771 4.75 5.75V12.75C4.75 13.3023 5.19771 13.75 5.75 13.75C6.30229 13.75 6.75 14.1977 6.75 14.75C6.75 15.3023 6.30229 15.75 5.75 15.75H4.75C3.64543 15.75 2.75 14.8546 2.75 13.75V4.75C2.75 3.64543 3.64543 2.75 4.75 2.75L18.75 2.75C19.8546 2.75 20.75 3.64543 20.75 4.75V13.75C20.75 14.8546 19.8546 15.75 18.75 15.75Z" fill="#C4C4C4"/>
								</svg></span>Attachment</a>
				...
				<div class="fv-row mb-10">
					...
					<label class="required form-label">Effect Confirmation</label>
						<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->effect??''); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label class="required form-label">Follow up. How will you ensure on-going PDCA?</label>
						<div class="text-primary mt-3">
								<?php echo nl2br($talent->twer2->followup??''); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<div class="text-muted fs-7">How will you share your learning with others? </div>
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer2->spread??''); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label for="statement" class="form-label required">What went well</label>
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer2->well??''); ?>
						...
						<label for="statement" class="form-label required">What did not go well</label>
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer2->notwell??''); ?>
				...
				<div class="fv-row mb-10">
					<div class="row">
						...
						<label for="statement" class="form-label required">What helped</label>
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer2->helped??''); ?>
						...
						<label for="statement" class="form-label required">What hindered</label>
						<div class="text-primary mt-3">
							<?php echo nl2br($talent->twer2->hindered??''); ?>
			...
			<?php if(Auth::user()->group_id==6 || Auth::user()->supervisor->count()>0): ?>
			<?php echo Form::model($talent->twer2??'null', array('route' => ['mark.twer'], 'method'=>'POST', 'id' => 'kt_add_mark_form2')); ?>

    		<input type="hidden" name="id" value="<?php echo e($talent->twer2->id??'null'); ?>">
			...
			<div class="fv-row mb-10">
				<div class="d-flex flex-column rounded-3 p-7 border border-dashed border-gray-400 bg-light-warning">
					...
					<!-- <div class="separator separator-dashed mb-7"></div> -->
						...
						<!-- <div class="form-floating">
						    <input type="text" class="form-control"  name="mark" id="floatingInput" value="<?php echo e($talent->twer2->mark??''); ?>" />
						    <label for="floatingInput">Mark</label>
						</div> -->
						<?php if(!is_null($talent->twer2->mark??null)): ?>
						<div class="form-floating" style="height:100px;top:-100px;z-index:1;margin-bottom:-100px"></div>
						<?php endif; ?>
						<div class="d-flex justify-content-end">
					<!--begin::Button-->
					<button type="submit" id="kt_add_mark_submit2" class="btn btn-sm <?php if(!$talent->twer2 || !is_null($talent->twer2->mark)): ?> btn-secondary disabled <?php else: ?> btn-primary <?php endif; ?>">
						<span class="indicator-label"><?php if(!is_null($talent->twer2->mark??null)): ?> Submitted <?php else: ?> Submit <?php endif; ?></span>
						<span class="indicator-progress">Please wait...
						<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
					</button>
					<!--end::Button-->
	...
	<div class="flex-column flex-lg-row-auto w-100 w-350px mb-10">
		...
		<div class="card card-flush bg-light-success mb-0 table-responsive">
			<!--begin::Card body-->
			<?php if(Auth::user()->group_id==6 || Auth::user()->supervisor->count()>0): ?>
			<?php echo Form::model($talent->twer2??'null', array('route' => ['assesst.twer'], 'method'=>'POST', 'id' => 'kt_add_twer_form2')); ?>
			...
			<div class="card-body fs-6 pe-3">
				<div class="scroll" id="twerContent">
					...
					<tbody class="fw-bold fs-7">
						...
						<tr>
							...
							<td>
								<!--begin::Checkbox-->
								<label class="form-check form-check-sm form-check-custom justify-content-end">
									<input class="form-check-input"  type="checkbox" value="<?php echo e($cat->id); ?>" <?php if(in_array($cat->id,explode(",",$talent->twer2->checklist??''))): ?> checked <?php endif; ?> name="checklist[]">
								</label>
								<!--end::Checkbox-->
							</td>
						</tr>
					...
					<div class="d-flex justify-content-end">
						<!--begin::Button-->
						<button type="submit" id="kt_add_twer_submit2" class="btn btn-sm btn-primary <?php if(!$talent->twer2): ?> disabled <?php endif; ?>">
							<span class="indicator-label">Submit</span>
							<span class="indicator-progress">Please wait...
							<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
						</button>
					...
					<div class="fv-row">
					     <h3 class="fs-7 text-gray-500 mb-0">Comment History</h3>
					     <?php if($talent->twer2 && $talent->twer2->comment->count()>0): ?>
						<table class="table align-middle table-rounded table-row-dashed table-row-gray-500 g-3">
						<tbody class="fw-bold fs-7">
							<?php $__currentLoopData = $talent->twer2->comment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<tr>
								<td>
									<?php echo e($c->comment); ?><br/>
									<span class="text-muted fs-8"><?php echo e($c->created_at); ?></span>
			...
			<div class="card-body fs-6 pe-3">
				<div class="scroll" id="twerContent">
				<h3 class="f-6 mb-5">Mark <span class="badge badge-primary fw-bolder p-3 ms-3 fs-6"><?php echo e($talent->twer2->mark??''); ?></span></h3>
				<h3 class="f-7 mb-5  text-gray-800">Checklist </h3>
				...
				<tbody class="fw-bold fs-7">
					...
					<tr>
						...
						<td>
							<!--begin::Checkbox-->
							<label class="form-check form-check-sm form-check-custom justify-content-end">
								<input class="form-check-input" disabled type="checkbox" value="<?php echo e($cat->id); ?>" <?php if(in_array($cat->id,explode(",",$talent->twer2->checklist??''))): ?> checked <?php endif; ?> name="checklist[]">
							</label>
							<!--end::Checkbox-->
						</td>
					</tr>
				...
				<div class="mb-10">
					<div class="form-check form-check-custom form-check-solid">
						<input class="form-check-input opentwer" name="open_id" <?php if($talent->twer2 && $talent->twer2->open_id): ?> checked="checked" <?php endif; ?> type="checkbox" value="2" id="opentwer2">
                    ...
                    s = document.getElementById("kt_add_twer_submit2");
	                    ...
	                    a.preventDefault(), 
							...
							data : $('#kt_add_twer_form').serialize(),
					    		url: "<?php echo e(url('')); ?>/supervisor/assest/twer",
						}).done(function(){
                    ...
                    w = document.getElementById("kt_add_mark_submit2");
	                    ...
	                    a.preventDefault(), 
							...
							data : $('#kt_add_mark_form').serialize(),
					    		url: "<?php echo e(url('')); ?>/supervisor/mark/twer",
						}).done(function(){
...
e.addEventListener("change", (a => {
	a.preventDefault(), 
		...
		$.ajax({
		type: 'POST',
		data: {talent_id: "<?php echo e($talent->id); ?>",series:e.value,flag:e.checked},
		url: "<?php echo e(url('open/talent/twer')); ?>",
	}).done(function(){
...
<?php if(Auth::user()->group_id==6 || Auth::user()->supervisor->count()>0): ?>
	...
	noUiSlider.create(slider, {
	    start: [<?php echo e($talent->twer1->mark??'15'); ?>],
	    connect: "lower",
	    step: 1,
	    tooltips: true,
	    format: wNumb({
	...
	noUiSlider.create(slider2, {
	    start: [<?php echo e($talent->twer2->mark??'15'); ?>],
	    connect: "lower",
	    step: 1,
	    tooltips: true,
	    format: wNumb({
...
<?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/twer.blade.php ENDPATH**/ ?>
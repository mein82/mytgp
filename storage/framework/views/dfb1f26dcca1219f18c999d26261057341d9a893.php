...
<html lang="en">
    ...
    <!--end::Head-->
    <!--begin::Body-->
    <body id="kt_body" class="bg-body" style="background-color: rgb(243, 244, 246 , 1) !important;">
        <!--begin::Main-->
        <!--begin::Root-->
...
<!--begin::Page Custom Javascript(used by this page)--><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/layouts/guest.blade.php ENDPATH**/ ?>
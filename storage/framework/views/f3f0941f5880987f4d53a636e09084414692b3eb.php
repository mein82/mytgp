...
<div class="card card-flush pt-5  mb-5 mb-lg-10" >
	...
	<div class="card-body p-6 fs-6 table-responsive">
		...
		<div class="col-3 fv-row mb-10 cohort d-none">
			...
			<!--end::Label-->
			<!--begin::Input-->
			<?php echo Form::text('cohort',null,['class'=>'form-control']); ?>
...
var KTModalUserSearch = function() {
    var e, t, n, s, a, f, c, d, g, h, yourArray = [], r = function(e) {
    		...
    		var cohort = document.querySelector('[name="cohort"]').value;
            setTimeout((function() {
                if(key!='')
                $.ajax({
                  method: "POST",
                  url: "<?php echo e(route('user.search')); ?>",
                  data: { keyword : key, type: type, cohort:cohort }
                }).done(function( view ) {
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/notification-form.blade.php ENDPATH**/ ?>
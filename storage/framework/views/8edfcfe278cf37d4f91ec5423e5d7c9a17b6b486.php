...
<div class="card-header border-0 pt-6">
	...
	<div class="card-toolbar">
		...
		<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
			...
			<a href="<?php echo e(url('new/lock')); ?>" class="btn btn-primary">
    ...
    <tbody class="text-gray-800">
        ...
        <?php $count++; ?>
            <tr>
                ...
                <td><span class="badge badge-secondary text-hover-gray-800"><?php echo e($item->type->name??''); ?></span><br/><?php echo e($item->name); ?></td>
                <td><?php echo e($item->start_date); ?></td>
                <td><?php echo e($item->end_date); ?></td>
                <td><?php echo e($item->users->count()); ?></td>
                <td class="d-none"><?php echo e($item->users->pluck('user.name')); ?></td>
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/lock/users/'.$item->id)); ?>" class="menu-link px-3">
                                Users
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/edit/'.$item->id.'/lock')); ?>" class="menu-link px-3">
                                Edit
                            </a>
                        </div>
                        <!--end::Menu item-->
            ...
            o.querySelectorAll('[data-kt-user-table-filter="delete_row"]').forEach((t => {
            	t.addEventListener("click", (function(t) {
                    ...
                    const n = t.target.closest("tr"),
                        ...
                        id = n.querySelectorAll("td")[6].querySelectorAll("[data-kt-user-table-filter='delete_row']")[0].getAttribute('id');
                    Swal.fire({
                    	...
                    	t.value ? ($.ajax({
								type: 'GET',
							    url: "<?php echo e(url('')); ?>/destroy/"+id+"/lock",
							}),
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/lock-control.blade.php ENDPATH**/ ?>
...
<input type="text" class="form-control form-control-lg form-control-solid" name="cohort" value="" placeholder="Search by Cohort" data-kt-search-element="input" />
					...
					<div class="py-5">
						<div data-kt-search-element="results" class="d-none">
							<form action="<?php echo e(route('add.lockusers')); ?>" method="POST">
							<?php echo csrf_field(); ?><!--begin::Users-->
							<input type="hidden" name="lock_id" value="<?php echo e($locks->id); ?>" />
...
<!--begin1::Toggle-->
				...
				<table id="kt_table_participant" class="table align-middle table-row-dashed table-row-gray-500 fs-6 gy-5">
					...
					<tbody class="text-gray-700">
						<?php $__currentLoopData = $locks->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<!--begin::Table row-->
						<tr>
							<td>
								<label class="form-check form-check-custom form-check-solid me-5">
							...
							<?php if($p->user->talent): ?>
								<span class="badge badge-light-success mb-1"><?php echo e($p->user->talent->status->cohort); ?></span>
							<?php else: ?>
			...
			<div class="card-body pt-0 fs-5">
				...
				<div class="mb-7">
					...
					<div class="d-flex align-items-center mb-1">
						<!--begin::Name-->
						<span class="fw-bolder me-2 text-gray-800"><?php echo e($locks->name); ?></span>
						<!--end::Name-->
					</div>
					<!--end::Details-->
				</div>
				...
				<div class="mb-7">
					...
					<div class="mb-0">
						<!--begin::Price-->
						<span class="fw-bold text-gray-800"><?php echo e(date("d M Y",strtotime($locks->start_date))); ?></span> - <span class="fw-bold text-gray-800"><?php echo e(date("d M Y",strtotime($locks->end_date))); ?></span>
						<!--end::Price-->
					</div>
					<!--end::Details-->
				</div>
				...
				<!--begin::Actions-->
				<div class="mb-0">
					<a href="<?php echo e(url('edit/'.$locks->id.'/lock')); ?>" class="btn btn-primary" id="kt_subscriptions_create_button">Edit Locks Detail</a>
				</div>
				<!--end::Actions-->
			</div>
			<!--end::Card body-->
...
var KTModalUserSearch = function() {
    var e, t, n, s, a, f, c, d, g, h, yourArray, r = function(e) {
            ...
            setTimeout((function() {
                ...
                $.ajax({
                  method: "POST",
                  url: "<?php echo e(route('apptalent.search')); ?>",
		...
		$('[name="allapplicant"]').on("change",function () { 
			if($(this).is(':checked')){
				$.ajax({
					method: "POST",
					url: "<?php echo e(route('applicant.search')); ?>",
        ...
        init: function() {
            ...
            document.querySelector('#kt_delete_participant').addEventListener("click", (function() {
            	($('[type="checkbox"]:not(#all):checked').length==0)?Swal.fire({
						...
						method: "POST",
						url: "<?php echo e(route('delete.lockusers')); ?>",
						data: { id : yourArray}
					}).done(function(){
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/lock-control-users.blade.php ENDPATH**/ ?>
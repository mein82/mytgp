...
<table id="kt_datatable_example_2" class="table align-middle border-bottom table-row-bordered table-striped table-row-gray-200 fs-6 gy-3 gs-7">
    ...
    <tbody class="text-gray-800">
        ...
        <?php $count = 0; ?>
            <tr>
                <td></td>
                <td><?php echo e($item->name); ?><br/><?php echo e($item->applicant->programme->name); ?>
                ...
                <td class="d-none"><?php if($count>=8): ?> Complete <?php else: ?> Incomplete <?php endif; ?></td>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/panel/applicants.blade.php ENDPATH**/ ?>
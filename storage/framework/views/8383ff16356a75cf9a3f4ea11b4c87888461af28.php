...
<div class="card">
	...
	<!--begin::Card body-->
	<div class="card-body">
	<form action="<?php echo e(route('add.selflogbook')); ?>" method="POST" id="kt_modal_new_target_form" method="POST">
	<?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/applicant/logbook.blade.php ENDPATH**/ ?>
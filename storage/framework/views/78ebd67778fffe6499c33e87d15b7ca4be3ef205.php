...
<?php $component = $__env->getContainer()->make(App\View\Components\AppLayout::class, ['activemenu' => 'sec-training']); ?>
	...
	<div class="card-toolbar">
		...
		<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
			...
			<!--end::Svg Icon-->Export</button>
				<!--end::Toggle-->
			<a href="<?php echo e(url('new/training')); ?>" class="btn btn-primary">
    ...
    <tbody class="text-gray-800">
        ...
        <?php $count = 0; ?>
            <tr>
                ...
                <td><?php echo e(date("d/m/Y",strtotime($item->start_date))); ?> - <?php echo e(date("d/m/Y",strtotime($item->end_date))); ?></td>
                <td><?php echo e($item->type->name??''); ?></td>
                <td><?php echo e($item->platform??''); ?></td>
                <td><?php echo e($item->domain->name??''); ?></td>
                <td class="text-center  text-gray-400 fs-4">
                	<span class="badge badge-light me-2"><?php echo e($item->participants->count()); ?></span>|<span class="badge badge-light-success ms-2"><?php echo e($item->participants->where('attendance_id',4)->count()); ?></span>
                </td>
                <td class="text-center text-gray-400 fs-4">
					<span class="badge badge-light-success me-2"><?php echo e($item->participants->where('status_id',1)->count()); ?></span>|<span class="badge badge-light-danger ms-2"> <?php echo e($item->participants->where('status_id',2)->count()); ?></span>
                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/training/participants/'.$item->id)); ?>" class="menu-link px-3" data-kt-user-table-filter="edit_row">
                                Participants
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/edit/'.$item->id.'/training')); ?>" class="menu-link px-3">
                                Edit
                            </a>
                        </div>
                        <!--end::Menu item-->
            ...
            o.querySelectorAll('[data-kt-user-table-filter="delete_row"]').forEach((t => {
            	t.addEventListener("click", (function(t) {
                    ...
                    Swal.fire({
                    	...
                    	t.value ? ($.ajax({
								type: 'GET',
							    url: "<?php echo e(url('')); ?>/destroy/"+id+"/training",
							}),
...
<?php endif; ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/secretariat/training.blade.php ENDPATH**/ ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\AppLayout::class, ['activemenu' => 'setting-code-title']); ?>
...
<div class="card-header border-0 pt-6">
	...
	<div class="card-toolbar">
		...
		<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
			...
			<a href="<?php echo e(url('new/title')); ?>" class="btn btn-primary">
                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="<?php echo e(url('/edit/'.$item->id.'/title')); ?>" class="menu-link px-3">
                                Edit
                            </a>
                        </div>
                        <!--end::Menu item-->
            ...
            o.querySelectorAll('[data-kt-user-table-filter="delete_row"]').forEach((t => {
            	t.addEventListener("click", (function(t) {
                    ...
                    Swal.fire({
                    	...
                    	t.value ? ($.ajax({
								type: 'GET',
							    url: "<?php echo e(url('')); ?>/destroy/"+id+"/title",
							}),
...
<?php endif; ?><?php /**PATH /var/www/html/mytgp/resources/views/secretariat/title.blade.php ENDPATH**/ ?>
...
<!--begin::User-->
<div class="rounded d-flex flex-stack bg-active-lighten p-4" id="wrapme" data-user-id="<?php echo e($item->id); ?>">
<!--begin::Details-->
<div class="d-flex align-items-center">
	...
	<div class="symbol symbol-35px symbol-circle">
		...
		<img alt="<?php echo e(substr($item->name, 0,1)); ?>" src="<?php echo e(url('')); ?>/photo/<?php echo e($item->avatar); ?>" />
		<?php else: ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /opt/homebrew/var/www/mytgp/resources/views/select-user-list.blade.php ENDPATH**/ ?>
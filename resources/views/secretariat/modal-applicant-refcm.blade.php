...
@foreach($logbooks as $logbook)
    <div class="col-lg-6 mb-10 mb-lg-0">
        ...
        <!--begin::User-->
            <div class="d-flex align-items-center flex-grow-1">
                ...
                <div class="symbol symbol-45px me-5">
                    @if($logbook->referee->avatar !='default.png')
                    <img alt="Pic" src="{{url('')}}/photo/{{$logbook->referee->avatar}}" />
                    @else
                    <span class="symbol-label bg-light-primary text-primary fw-bold">{{substr($logbook->referee->name, 0,1)}}</span>
                    @endif
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="#" class="text-gray-800 text-hover-primary fs-4 fw-bolder me-1">{{$logbook->referee->name}}</a>
                    </div>
                    <!--end::Name-->
                    <!--begin::Info-->
                    <div class="d-flex flex-wrap fw-bold fs-6 mb-2 pe-2">
                        ...
                        <!--end::Svg Icon-->{{$logbook->referee->email}}</a>
                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                        ...
                        <!--end::Svg Icon-->{{$logbook->referee->designation}}</a>
                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                        ...
                        <!--end::Svg Icon-->{{$logbook->referee->organization}}</a>
        ...
        <div class="separator separator-content  mb-10 border-primary"><span class="w-300px fw-bolder">{{$cat->name}} ({{$cat->code}})</span></div>
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Label-->
            <label class="d-flex align-items-center form-label mt-3"><span class="bullet bullet-vertical me-5"></span>{{$log->remark}}
            </label>
            <!--end::Label-->
            </div>
            <div class="col-12">

<x-app-layout activemenu="sec-talent-assesment-mark">
<x-slot name="header">
	Talents
</x-slot>
        ...
        @endphp
            <tr>
                ...
                <td class="text-center fw-bolder">
                    {{$item->talent->course->where('attendance_id',4)->count()??'0'}}
                </td>
                <td class="text-center fw-bolder">
                    @php 
                ...
                <td class="text-center subtotal1 fw-bolder">{{$subtotal1}}</td>
                <td class="text-center"><!--begin::Input group-->
                    <div class="input-group w-100px m-auto" kt-value="{{$item->talent->id}}" kt-type="cv">
                        <input type="text" name="finalmark1[]" value="{{$data->cv??0}}" class="form-control form-control-sm finalmark" placeholder="" aria-describedby="basic-addon2"/>
                ...
                <td class="text-center"><!--begin::Input group-->
                    <div class="input-group w-100px m-auto" kt-value="{{$item->talent->id}}" kt-type="project">
                        <input type="text" name="finalmark2[]"  value="{{$data->project??0}}" class="form-control form-control-sm finalmark" placeholder="" aria-describedby="basic-addon2"/>
                        <button class="btn btn-secondary btn-icon save btn-sm"  type="button">
                            <span class="indicator-label">
                            <i class="bi bi-save2 fs-2"></i>
                            </span>
                ...
                <td class="text-center"><!--begin::Input group-->
                    <div class="input-group w-100px m-auto" kt-value="{{$item->talent->id}}" kt-type="self">
                        <input type="text" name="finalmark3[]" value="{{$data->self??0}}" class="form-control form-control-sm finalmark" placeholder="" aria-describedby="basic-addon2"/>
                        <button class="btn btn-secondary btn-icon save btn-sm"  type="button">
                            <span class="indicator-label">
                            <i class="bi bi-save2 fs-2"></i>
                            </span>
                ...
                <td class="text-center subtotal2 fw-bolder">{{$subtotal2}}</td>
                @php $total = $subtotal1+$subtotal2;@endphp
                <td class="text-center total fw-bolder">{{$total}}</td>
                <td class="d-none">
                	{{$item->talent->status->finals->name??''}}
			    </div>
            </tr>
        @endforeach
    </tbody>

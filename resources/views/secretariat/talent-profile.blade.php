<x-app-layout activemenu="sec-talent-profile">
<x-slot name="header">
	Talent
</x-slot>
        ...
        @php $count = 0; @endphp
            <tr>
                ...
                <td>{{$item->name}}<br/>
                    ...
                    @if(!$item->talent->profile)
                	<br/><span class="badge badge-light-info">Pending profile</span>
                	@endif
                	@if($item->talent->profile && $item->talent->profile->generated==0)
                ...
                <td class="text-end">
                    ...
                    @if(file_exists(public_path('attachment/talent_profile/TALENTPROFILE_'.$item->talent->talent_code.'.pdf'))) 
                    <a href="{{url('attachment/talent_profile/TALENTPROFILE_'.$item->talent->talent_code.'.pdf')}}" target="_blank">
                    <div class="d-flex"> 
                        <!--begin::Symbol-->
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-150px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="{{url('/talent/profile/'.$item->id)}}" class="menu-link px-3">
                                Profile
                            </a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <!--begin::Menu item-->
                        <!-- <div class="menu-item px-3">
                            <a href="{{url('/talentprofile/'.$item->id.'/generate')}}" class="menu-link px-3">
                                Generate Profile
                            </a>
                        </div> -->
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3 text-start">
                            <a href="{{url('/talent/achievement/'.$item->id)}}" class="menu-link px-3">
                                Achievement Report
                            </a>
                        </div>
                        <!--end::Menu item-->
...
KTUtil.onDOMContentLoaded((function() {
    ...
    $("#kt_modal_profile").on('show.bs.modal', function (e) {
        ...
        $.get( "{{url('talent/profile')}}/"+id+'/modal', function( data ){

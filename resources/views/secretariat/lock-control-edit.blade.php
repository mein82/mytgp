...
{!! Form::model($data, array('route' => ['update.lock', $data->id], 'method'=>'PATCH', 'id' => 'kt_add_lock_form')) !!}
<!--begin::Card-->
	...
	<div class="card-body pt-0">
		...
		<div class="row g-9 mb-7">
			...
			<div class="col-md-2 fv-row">
				...
				<!--end::Label-->
				<!--begin::Input-->
				{!! Form::select('type_id', $type, null, ['class'=>'form-select form-select-solid fw-bolder','title'=>'Choose','data-control'=>'select2', 'aria-label' =>'', 'data-placeholder'=>'Select', 'data-hide-search'=>'true', 'data-allow-clear'=>'true' ]) !!}
				<!--end::Input-->
			</div>
			<!--end::Col-->
			<!--begin::Col-->
...
<div class="d-flex justify-content-end">
	<!--begin::Button-->
	<a href="{{url('/setting/lock')}}" id="kt_add_lock_cancel" class="btn btn-light me-5">Cancel</a>
	<!--end::Button-->
	<!--begin::Button-->

...
<div class="card-header border-0 pt-6">
	...
	<div class="card-toolbar">
		...
		<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
			...
			<a href="{{url('new/ttknow')}}" class="btn btn-primary">
            ...
            <tr>
                ...
                <td><div class="d-flex align-items-center">
                    ...
                    <!--begin::Avatar-->
                        ...
                        <!--begin::Details-->
                        <div class="ms-5">
                            <a href="{{url('thingstoknow/'.$item->url)}}" target="_blank" class="fs-5 fw-bolder text-gray-900 text-hover-primary mb-2">{{$item->title}}</a>
                        </div>
                        <!--end::Details-->
                    </div></td>
                    <td>{{App\Models\Group::whereIn('id',explode(",",$item->group_id))->pluck('name')->implode(', ')}}</td>
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="{{url('/edit/'.$item->id.'/ttknow')}}" class="menu-link px-3">
                                Edit
                            </a>
                        </div>
                        <!--end::Menu item-->

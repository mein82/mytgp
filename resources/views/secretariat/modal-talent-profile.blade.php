...
@endphp
{!! Form::model($talent->profile,array('route' => ['update.talentprofile',$talent->id], 'method'=>'post', 'novalidate' => 'novalidate')) !!}	
<!--begin::Details-->
...
<div class="d-flex flex-column mb-8">
	...
	{!!  Form::hidden('image_'.$code[$dom->id], null , array('id'=>'image_'.$code[$dom->id]))!!} 
			...
			<div class="col-6">
				...
				<div class="mb-15">
					@if(getLevel(isset($ref[0])&& isset($ref[1]) ?number_format(($ref[0]->$att+$ref[1]->$att)/2,1,'.'):0.0)<4)

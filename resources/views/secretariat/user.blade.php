<x-app-layout activemenu="setting-user">
<x-slot name="header">
	User
</x-slot>
...
<div class="card-header border-0 pt-6">
	...
	<div class="card-toolbar">
		...
		<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
            ...
            <!--begin::Menu wrapper-->
			<div class="m-0">
			<a href="{{url('new/user')}}" class="btn btn-primary">
        ...
        @php $count = 0; @endphp
            <tr>
                ...
                <td>
                    ...
                    <div class="fw-bold text-muted fs-7">{{$item->organization}}</div>
                    <div class="fw-bold text-muted fs-7">{{$item->contactno}}</div>
                </td>
                <td>
                    {!!$item->role!!}
                </td>
                ...
                <td class="text-end">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="{{url('/edit/'.$item->id.'/user')}}" class="menu-link px-3">
                                Edit
                            </a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="#" id="{{$item->id}}" class="menu-link px-3" data-kt-user-table-filter="reset_row">
                                Reset
                            </a>
                        </div>
                        <!--end::Menu item-->
            ...
            o.querySelectorAll('[data-kt-user-table-filter="log_row"]').forEach((t => {
            	t.addEventListener("click", (function(t) {
                    ...
                    const n = t.target.closest("tr"),
                        ...
                        window.location = "{{url('')}}/impersonate/user/"+id+"/setting-user";
                }))
            }))
        },
        d = () => {

...
<div class="card">
    ...
    <!--begin::User-->
            <div class="d-flex align-items-center flex-grow-1">
                ...
                <div class="symbol symbol-45px me-5">
                    <img src="{{url('photo/'.$talent->user->avatar)}}" alt="">
                </div>
                <!--end::Avatar-->
                <!--begin::Info-->
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{$talent->user->name}}</a>
                    </div>
                    <!--end::Name-->
                    <!--begin::Info-->
                    <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                        ...
                        <!--end::Svg Icon-->{{$talent->user->designation}}</a>
                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
	...
	<form action="{{route('add.reflogbook')}}" method="POST" id="kt_modal_new_target_form" method="POST">
	@csrf
...
<span class="text-gray-600 fw-bold">{{$log->item}}</span>
			...
			<div class="col">
                ...
                <div class="col">
					<!--begin::Option-->
					<label class="btn btn-outline btn-outline-dashed btn-outline-info btn-active-info w-100 mt-3 p-2 @if($logbook->$q == $i) active @endif {{$disabled}}" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$tip}}">

...
<html lang="en">
    ...
    <head><base href="">
        ...
        <link href="{{url('')}}/css/ticker-style.css" rel="stylesheet" type="text/css" />
                        ...
                        <div class="container-xxl d-flex flex-grow-1 flex-stack">
                            ...
                            <div class="d-flex align-items-center me-5">
                                ...
                                <a href="{{url('dashboard')}}">
                                    <img alt="Logo" src="{{url('logo/mytgp-logo.png')}}" class="h-35px h-lg-40px" />
                                </a>
                                <!--end::Logo-->
...
<path d="M19 15V18C19 18.6 18.6 19 18 19H6C5.4 19 5 18.6 5 18V15C6.1 15 7 14.1 7 13V10C7 7.6 8.7 5.6 11 5.1V3C11 2.4 11.4 2 12 2C12.6 2 13 2.4 13 3V5.1C15.3 5.6 17 7.6 17 10V13C17 14.1 17.9 15 19 15ZM11 10C11 9.4 11.4 9 12 9C12.6 9 13 8.6 13 8C13 7.4 12.6 7 12 7C10.3 7 9 8.3 9 10C9 10.6 9.4 11 10 11C10.6 11 11 10.6 11 10Z" fill="black"/>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                                        ...
                                        <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{url('')}}/assets/media/misc/pattern-1.jpg')">
                                            ...
                                            <!-- <span class="fs-8 opacity-75 ps-3">{{$alerts->count()}} reports</span> --></h3>
                                            <!--end::Title-->
                                            <!--begin::Tabs-->
                                            ...
                                            <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                                                ...
                                                <div class="scroll-y mh-325px my-5 px-8">
                                                    ...
                                                    <div class="d-flex flex-stack py-4">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--begin::Title-->
                                                            <div class="mb-0 me-2">
                                                                <a href="{{url($item->url)}}" class="fs-6 text-gray-800 text-hover-primary fw-bolder">{{$item->title}}</a>
                                                        ...
                                                        <!--end::Section-->
                                                        <!--begin::Label-->
                                                        <span class="badge badge-light fs-8">{{time_elapsed_string($item->created_at)}}</span>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Item-->
                                                    @endforeach
                                                ...
                                                <div class="d-flex flex-column px-9">
                                                    ...
                                                    <div class="text-center px-4">
                                                        <img class="mw-100 mh-200px" alt="image" src="{{url('')}}/assets/media/illustrations/sketchy-1/5.png" />
                                                    </div>
                                                    <!--end::Illustration-->
                                                </div>
                                                <!--end::Wrapper-->
                                ...
                                <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        <img src="{{url('photo/'.Auth::user()->avatar)}}" alt="user" />
                                    </div>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                <!--begin::Avatar-->
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="Logo" src="{{url('photo/'.Auth::user()->avatar)}}" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Username-->
                                        ...
                                        <div class="menu-item px-5 my-1">
                                            <a href="{{url('account-setting')}}" class="menu-link px-5">Account Setting</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                    ...
                    <div class="toolbar py-5 py-lg-7" id="kt_toolbar">
                        ...
                        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
                            ...
                            <div class="page-title d-flex flex-column me-3">
                                <!--begin::Title-->
                                <x-pagetitle :dashboard="$dashboard??''" :header="$header??''" :subheader="$subheader??''"/>
                                <!--  end::Title-->
                            </div>
                            <!--end::Page title-->
                            <div class="d-flex align-items-center py-1">
                                ...
                                <span class="text-gray-800 fs-6">Supervisor:</span><span class="text-dark fs-6 mx-2 fw-bolder">{{Auth::user()->talent->supervisor->super->name??'NOT AVAILABLE'}}</span> 
                                @endif
                                @if(Auth::user()->group_id>4 || Auth::user()->supervisor->count()>0)
                                ...
                                @if(Auth::user()->group_id==4 || Auth::user()->group_id==6)
                                <!--begin::Menu wrapper-->
                                <div class="m-0 d-none">
                                    <!--begin1::Toggle-->
                                    <form id="applicant-form" action="{{ route('register.applicant') }}" method="POST">
                    ...
                    <div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-fluid">
                        ...
                        <div class="content flex-row-fluid" id="kt_content">
                                <x-alerts class="mb-4" :status="session('status')" :error="session('error')" />
        ...
        <div class="engage-toolbar d-flex position-fixed px-5 fw-bolder zindex-2 top-50 end-0 transform-90 mt-20 gap-2">
            <!--begin::Purchase link-->
            @if(\Session::has('impersonate'))<a href="{{url('reverse/impersonate/user')}}" class="engage-purchase-link btn btn-flex h-45px bg-body btn-color-gray-700 btn-active-color-gray-900 px-5 shadow-sm rounded-top-0">Reverse Impersonate <br/>{{Auth::user()->name}}</a>@endif
            <!--end::Purchase link-->
        </div>
        <!--end::Engage toolbar-->
        <!--begin::Scrolltop-->
        ...
        <script src="{{url('')}}/assets/plugins/custom/ckeditor5/build/ckeditor.js"></script>
        <!--end::Page Vendors Javascript-->
        
        <script type="text/javascript" src="{{url('')}}/js/acmeticker.js"></script>
        <script src="{{url('')}}/js/textcounter.min.js"></script>
        ...
        $("#kt_modal_courses").on('show.bs.modal', function (e) {
            ...
            $.get( "{{url('talent/courses')}}/"+id+'/modal', function( data ){
        ...
        $("#kt_modal_project").on('show.bs.modal', function (e) {
            ...
            $.get( "{{url('talent/project')}}/"+id+'/modal', function( data ){
                modal.find('.modal-load').html(data);
            });
        });

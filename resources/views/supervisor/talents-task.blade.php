    ...
    <tbody class="text-gray-800">
        ...
        @php $count = 0; @endphp
            <tr>
                ...
                <td>
					<span class="badge badge-{{!is_null($item->talent->superlog2)?'success':'warning'}}">{{!is_null($item->talent->superlog2)?'Completed':'Pending'}} 1st Year</span><br/>
					<span class="badge badge-{{!is_null($item->talent->superlog3)?'success':'warning'}}">{{!is_null($item->talent->superlog3)?'Completed':'Pending'}} 2nd Year</span>
				</td>
				<td>
					<span class="badge badge-{{!is_null($item->talent->twer1)&&!is_null($item->talent->twer1->mark)?'success':'warning'}}">{{!is_null($item->talent->twer1)&&!is_null($item->talent->twer1->mark)?'Completed':'Pending'}} 1st Year</span><br/>
					<span class="badge badge-{{!is_null($item->talent->twer2)&&!is_null($item->talent->twer2->mark)?'success':'warning'}}">{{!is_null($item->talent->twer2)&&!is_null($item->talent->twer2->mark)?'Completed':'Pending'}} 2nd Year</span>
				</td>
                ...
                <td class="text-end">
                    <a href="{{url('/supervisor/talent/summary/'.$task.'/'.$item->id)}}" class="btn btn-bg-light btn-color-gray-900 btn-active-primary btn-sm">@if($task=="project-progress") Review @else Evaluate @endif</a>
                    <!-- <a href="{{url('/supervisor/talent/summary/'.$item->id)}}" class="btn btn-dark btn-active-light-primary btn-sm">Evaluate</a> -->
                </td>
            </tr>
        @endforeach
    </tbody>

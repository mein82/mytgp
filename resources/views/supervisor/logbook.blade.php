<form action="{{route('add.supervisorlogbook')}}" method="POST" id="kt_modal_new_target_form" method="POST">
	@csrf
...
<span class="text-gray-600 fw-bold">{{$log->item}}</span>
		...
		<button type="submit" id="kt_modal_new_target_submit" class="btn {{(!$edit)?'btn-secondary':'btn-primary'}} {{$disabled}}">

<x-app-layout activemenu="document">
						...
						<tr>
							...
							<td>
								<div class="d-flex align-items-center mw-300px text-truncate">
									...
									<!--end::Svg Icon-->
									<a href="{{url('attachment/'.$item->type->filepath.$item->filename)}}" target="_blank" class="text-gray-800 text-hover-primary">{{$item->filename}}</a>
								</div>
							</td>
							<!--end::Name=-->
							<!--begin::Size-->
							...
							<td class="text-end" data-kt-filemanager-table="action_dropdown">
								<div class="d-flex justify-content-end">
									<!--begin::More-->
									<div class="ms-2">
										<button type="button" class="btn btn-sm btn-icon btn-danger btn-active-light-danger" data-kt-filemanager-table-filter="delete_row" data-id="{{$item->id}}">
					...
					<form class="form" action="none" id="kt_modal_upload_form">
						...
						<div class="modal-body pt-10 pb-15 px-lg-17">
							...
							<div class="fv-row mb-10 row-point" style="display:none">
								...
								<!--end::Label-->
								<!--begin::Input-->
								{!! Form::text('point',null,['class'=>'form-control form-control-solid']) !!}
        ...
        init: function() {
            ...
            (() => {
                ...
                r.on("sending",function(file,xhr,data){
					data.append("file_id",document.querySelector("[name='file_id']").value), data.append("point",document.querySelector("[name='point']").value);
				}),

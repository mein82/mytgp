            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-15">
                    ...
                    <a href="../../demo14/dist/index.html" class="mb-10 pt-lg-10">
                        <img alt="Logo" src="{{url('')}}/logo/mytgp-logo.png" class="h-100px mb-5" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Wrapper-->
                    ...
                    <!--end::Wrapper-->
                    <!--begin::Illustration-->
                    <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-300px" style="background-image: url({{url('')}}/assets/media/illustrations/sigma-1/17.png"></div>
                    <!--end::Illustration-->
                </div>
                <!--end::Content-->
